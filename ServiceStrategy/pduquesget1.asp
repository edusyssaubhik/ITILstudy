...
<table width="40%" border="0" cellpadding="0" cellspacing="0">
      ...
      <form method="post" action="/ServiceStrategy/pduquesget1.asp">
    ...
    <FORM METHOD="POST" ACTION="/ServiceStrategy/pduquesget2.asp">
    ...
    <%else
		...
		rsQues.Open "SELECT Question_StrategyDB.QuestionDesc, Question_StrategyDB.ExhibitURL ,Choice_StrategyDB.ChoiceNumber, Choice_StrategyDB.ChoiceValue from Question_StrategyDB, Choice_StrategyDB WHERE Question_StrategyDB.KNo='"&KNo&"' and Choice_StrategyDB.KNo='"&KNo&"' and Question_StrategyDB.QuestionNo='"&sArray(nCurNo,0,0)&"' and Question_StrategyDB.QuestionNo=Choice_StrategyDB.QuestionNo Order by Choice_StrategyDB.ChoiceNumber"
		...
		ChoiceValue4=rsQues("ChoiceValue")%>
            ...
            <tr>
              <td height="84" colspan="2" class="TableRowOdd"><div align="left"><span class="PopupCopy">
                  ...
                  <a href="/ServiceStrategy/pdusindex.asp" onclick="return ExitAlert(this.href);"><input type="button" class="ButtonTest" value="Exit" /></a>
                  </span></td>
            </tr>
          </table>
    </form>
...
%>
    There are no questions
     <a href="/ServiceStrategy/pdusindex.asp"><input type="button" class="ButtonTest" value="Exit" /></a>
    <%End If
%>
    <%Session("PDUArray")=sArray
%>
