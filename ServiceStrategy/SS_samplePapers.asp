...
<table width="930" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="8">
    <tr>
      ...
      <td width="73%" class="PageTitle">Service Strategy Sample Papers<a href="/ITIL/help.asp#APMG-sample-paper" style="float:right; margin-right:20px;"><img src="/images/buttons/Help.png" height="20px" style="border-color:#FFFFFF" onmouseover="this.src='/images/buttons/help_h.png'" onmouseout="this.src='/images/buttons/Help.png'"></a></td>
    </tr>
    <tr>
...
<br /><br />
        <table width = "75%" border="0" cellpadding="0" cellspacing="0" class="TableGeneral">
           <tr>
                    <td class="TableRowOdd"><b>Service Strategy Sample Paper1</b></td>
                    <td class="TableRowOdd"><b>Service Strategy Sample Paper2</b></td>
                    
                  </tr>
				  
				   <tr>
                    <td class="TableRowEven" ><a href="/ServiceStrategyDocs/SSpapers/SSpaper1-scenarios.pdf" target="_blank">Scenario</a></td>
                   
                    <td class="TableRowEven" ><a href="/ServiceStrategyDocs/SSpapers/SSpaper2-scenarios.pdf" target="_blank">Scenario</a></td>
                  </tr>
                    <tr>
                    <td class="TableRowEven" ><a href="/ServiceStrategyDocs/SSpapers/SSpaper1-questions.pdf" target="_blank">Question</a></td>
                    
                    <td class="TableRowEven" ><a href="/ServiceStrategyDocs/SSpapers/SS paper2- questions.pdf	" target="_blank">Question</a></td>
                   
                  </tr>
                   
                  <tr>
                    <td class="TableRowEven" ><a href="/ServiceStrategyDocs/SSpapers/SSPaper1-answers.pdf" target="_blank">Answer and Rationale</a></td>
                    
                    <td class="TableRowEven" ><a href="/ServiceStrategyDocs/SSpapers/SSpaper2-answers.pdf" target="_blank">Answer and Rationale</a></td>
