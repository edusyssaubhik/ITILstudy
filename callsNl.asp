...
Dim strGermanyState, objRs, objRs1
...
<table border="1" cellpadding="5" cellspacing="0" align="center" width="45%">
 ...
 <tr>
  <td>
  <form name="addcalls" action="addCallsNl.asp" method="post" onsubmit="return Form_Validator(this)">
...
<tr>
	 ...
	 <td>  <select name="state">
	  ...
	  'Retrive the states'
		...
		strGermanyState = "SELECT Distinct state As States, state_code As StateCode FROM ITIL_city WHERE country = 'Netherlands' ORDER BY state"
