...
rsQues.Open "SELECT Question_OSAsample2.QuestionDesc, Question_OSAsample2.Question, Question_OSAsample2.CorrectChoice, Question_OSAsample2.Justification, Choice_OSAsample2.ChoiceNumber, Choice_OSAsample2.ChoiceValue, Choice_OSAsample2.ChoiceRate from Question_OSAsample2, Choice_OSAsample2 WHERE Question_OSAsample2.QuestionNo='"&QuesNo&"' and Question_OSAsample2.QuestionNo=Choice_OSAsample2.QuestionNo ORDER by Choice_OSAsample2.ChoiceNumber"

If Not rsQues.BOF Then%>
<P align="center"><B>View/Edit/Add given question:</B><BR><BR></P>
<B><U>View Question:</U></B>&nbsp;&nbsp;&nbsp;<B><a href="./writequesOSA_Sample2.asp">Home Page</A></B>
<form method="post" action="./writequesOSA_Sample2.asp">
...
<P align="center"><B>View/Edit/Add given question:</B><BR><BR></P>
Information updated in database<B><U>View Question:</U></B>&nbsp;&nbsp;&nbsp;<B><a href="./writequesOSA_Sample2.asp">Home Page</A></B>
<%
QuesNo=Request.Form("QuesNo")
KNo=Request.Form("KNo")
QuesNoPrev=int(QuesNo)-1%>
...
connObj.Execute "INSERT INTO Question_OSAsample2 (QuestionNo, QuestionDesc, Question, CorrectChoice, Justification) VALUES ('"&quesno&"','"&questiondesc&"','"&question&"','"&correctchoice&"','"&justification&"')"
connObj.Execute "INSERT INTO Choice_OSAsample2(QuestionNo, ChoiceNumber,ChoiceValue,ChoiceRate) VALUES ('"&quesno&"','"&choice1&"','"&choicevalue1&"','"&ChoiceRate1&"')"
connObj.Execute "INSERT INTO Choice_OSAsample2(QuestionNo, ChoiceNumber,ChoiceValue,ChoiceRate) VALUES ('"&quesno&"','"&choice2&"','"&choicevalue2&"','"&ChoiceRate2&"')"
connObj.Execute "INSERT INTO Choice_OSAsample2(QuestionNo, ChoiceNumber,ChoiceValue,ChoiceRate) VALUES ('"&quesno&"','"&choice3&"','"&choicevalue3&"','"&ChoiceRate3&"')"
connObj.Execute "INSERT INTO Choice_OSAsample2(QuestionNo, ChoiceNumber,ChoiceValue,ChoiceRate) VALUES ('"&quesno&"','"&choice4&"','"&choicevalue4&"','"&ChoiceRate4&"')"
addoredit="edit"
else
Response.Write("I am in Edit")
connObj.Execute "update Question_OSAsample2 Set QuestionDesc='"&questionDesc&"', Question='"&question&"', Justification='"&Justification&"', CorrectChoice='"&CorrectChoice&"' Where QuestionNo='"&quesno&"'"
connObj.Execute "update Choice_OSAsample2 Set ChoiceValue='"&ChoiceValue1&"' , ChoiceRate='"&ChoiceRate1&"' Where  questionno='"&quesno&"' and ChoiceNumber='"&choice1&"'"
connObj.Execute "update Choice_OSAsample2 Set ChoiceValue='"&ChoiceValue2&"' , ChoiceRate='"&ChoiceRate2&"' Where  questionno='"&quesno&"' and ChoiceNumber='"&choice2&"'"
connObj.Execute "update Choice_OSAsample2 Set ChoiceValue='"&ChoiceValue3&"' , ChoiceRate='"&ChoiceRate3&"' Where  questionno='"&quesno&"' and ChoiceNumber='"&choice3&"'"
connObj.Execute "update Choice_OSAsample2 Set ChoiceValue='"&ChoiceValue4&"' , ChoiceRate='"&ChoiceRate4&"' Where questionno='"&quesno&"' and ChoiceNumber='"&choice4&"'"
...
<P align="center"><B>View/Edit/Add given question:</B><BR><BR></P>
<%QuesNo=Request.Form("QuesNo")%>
Question <%=QuesNo%> deleted from database<B><U>View Question:</U></B><form method="post" action="./writequesOSA_Sample2.asp">
<%
QuesNoPrev=int(QuesNo)-1%>
<input type="hidden" name="QuesNo" value="<%=QuesNoPrev%>">
<input type="hidden" name="submitvalue" value="Initialize">
...
connObj.Execute "delete from Question_OSAsample2 Where  QuestionNo='"&quesno&"'"
connObj.Execute "delete from Choice_OSAsample2 Where  questionno='"&quesno&"'"
...
<BR><BR>
 ...
 <%Else
  ...
  Response.Redirect("/access_OSAsample2.asp")
