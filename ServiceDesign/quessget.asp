    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td colspan="2" height="84" class="TableRowOdd"><div align="left">
            ...
            <a href="/ServiceDesign/chapterTestsIndex.asp" onclick="return ExitAlert(this.href);"><input type="button" class="ButtonTest" value="Exit" /></a>
          </td>
