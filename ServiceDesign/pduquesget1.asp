...
<table width="40%" border="0" cellpadding="0" cellspacing="0">
      ...
      <form method="post" action="/ServiceDesign/pduquesget1.asp">
    ...
    <FORM METHOD="POST" ACTION="/ServiceDesign/pduquesget2.asp">
    ...
    <%else
		...
		rsQues.Open "SELECT Question_DesignDB.QuestionDesc, Question_DesignDB.ExhibitURL ,Choice_DesignDB.ChoiceNumber, Choice_DesignDB.ChoiceValue from Question_DesignDB, Choice_DesignDB WHERE Question_DesignDB.KNo='"&KNo&"' and Choice_DesignDB.KNo='"&KNo&"' and Question_DesignDB.QuestionNo='"&sArray(nCurNo,0,0)&"' and Question_DesignDB.QuestionNo=Choice_DesignDB.QuestionNo Order by Choice_DesignDB.ChoiceNumber"
		...
		ChoiceValue4=rsQues("ChoiceValue")%>
            ...
            <tr>
              <td height="84" colspan="2" class="TableRowOdd"><div align="left"><span class="PopupCopy">
                  ...
                  <a href="/ServiceDesign/pdusindex.asp" onclick="return ExitAlert(this.href);"><input type="button" class="ButtonTest" value="Exit" /></a>
                  </span></td>
            </tr>
          </table>
    </form>
...
%>
    There are no questions
     <a href="/ServiceDesign/pdusindex.asp"><input type="button" class="ButtonTest" value="Exit" /></a>
    <%End If
%>
    <%Session("PDUArray")=sArray
%>
