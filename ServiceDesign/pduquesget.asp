            ...
            <td width="73%" rowspan="4" background="/images/back/left_line.jpg" class="general-body">
                ...
                <div>
                  <%
					...
					rsQues1.Open "SELECT CorrectChoice,QuestionNo FROM Question_DesignDB WHERE Question_DesignDB.KNo='"&KNo&"'"
                ...
                <div>
                  ...
                  <form method="post" action="/ServiceDesign/pduquesget1.asp" target="_blank">
