...
-->
			...
			<!--15 question Free Online test to understand ITIL exam -->
                ...
                <tr onMouseOver="javascript:highlightTableRowVersionA(this, '#FFFFCC');">
                  <td height="108" class="TableRowOdd"><a href="/ITILonline.asp?action=30days" target="_blank"><span class="TableCopyName"> ITILstudy ITIL Foundation (Online Course) :</span> <span class="TableCopyDetails"> Priced at
                    ...
                    <span class="TableCopyCost"> $ 100 </span>
                    ...
                    <% End If %>
                    for 30 Days (This includes E-learning through Study Guides, Chapter Test and podcasts for all chapters along with 18 PMI PDU Certificate) </span></a></td>
                  <% 'CCavenue for India 
                ...
                <% ' CCAvenue and Paypal for other countries 
				Else
                ...
                <tr onMouseOver="javascript:highlightTableRowVersionA(this, '#FFFFCC');">
                  <td height="108" class="TableRowEven"><a href="/ITILonline.asp?action=60days" target="_blank"><span class="TableCopyName">ITILstudy ITIL Foundation (Online Course) :</span> <span class="TableCopyDetails"> Priced at
                    <%  If Session("CountryOrigin") = "US" OR Session("CountryOrigin") = "Canada" OR Session("CountryOrigin") = "UAE" OR Session("CountryOrigin") = "Singapore" OR Session("CountryOrigin") = "India" OR Session("CountryOrigin") = "Other" Then %>
                    <span class="TableCopyCost">
                    <%' = Currency_Format_Front %>
                    $ 175
                ...
                <tr onMouseOver="javascript:highlightTableRowVersionA(this, '#FFFFCC');">
                  <td height="108" class="TableRowOdd"><a href="/ITILonline.asp?action=90days" target="_blank"><span class="TableCopyName">ITILstudy ITIL Foundation (Online Course) :</span> <span class="TableCopyDetails">Priced at
                    <%  If Session("CountryOrigin") = "US" OR Session("CountryOrigin") = "Canada" OR Session("CountryOrigin") = "UAE" OR Session("CountryOrigin") = "Singapore" OR Session("CountryOrigin") = "India"  OR Session("CountryOrigin") = "Other" Then %>
                    <span class="TableCopyCost">
                    <%' = Currency_Format_Front %>
                    $ 225
                    ...
                    <% End If %>
                    for 90 Days (This includes E-learning through Study Guides, Chapter Test and podcasts for all chapters along with 18 PMI PDU Certificate) </span></a></td>
                  <% If Session("CountryOrigin") = "India" Then %>
                  <form method="post" action="http://mycatstudy.com/itilstudy_ccavenue.asp" onSubmit="return validate_form(this)">
                    <input type="hidden" name="item_name" value="ITIL Foundation Online Course">
				...
				<tr onMouseOver="javascript:highlightTableRowVersionA(this, '#FFFFCC');">
                  <td class="TableRowOdd" width="60%"><a name="OSA"></a><img src="/images/buttons/OSA.png" ></td>
                  <td class="TableRowOdd" colspan="3" ><div align="center"><span class="Header">OSA Course</span></div></td>
                </tr>
				  <tr onMouseOver="javascript:highlightTableRowVersionA(this, '#FFFFCC');">
                  <td height="108" class="TableRowEven"><a href="/ITILonline.asp?action=60days" target="_blank"><span class="TableCopyName">ITILstudy ITIL Intermediate OSA (Online Course) :</span> <span class="TableCopyDetails"> Priced at
              ...
              <!--  <td class="TableRowEven"><form method="post" action="http://www.pmstudy.com/itilOnline_ccavenue.asp">
                  ...
                  <td class="TableRowEven" colspan="2"><div align="center"><form action="https://www.paypal.com/cgi-bin/webscr" method="post">
					  ...
					  <% ElseIf Session("CountryOrigin") = "UAE" Then %>
                      <input type="hidden" name="amount" value="2442">
					  <% ElseIf Session("CountryOrigin") = "Singapore" Then %>
                      <input type="hidden" name="amount" value="838">
                      <% End If%>
                      <input type="hidden" name="return" value="http://www.itilstudy.com/customerdetails.asp">
                      <input type="hidden" name="rm" value="2">
                      <%  If Session("CountryOrigin") = "US" OR Session("CountryOrigin") = "Canada" OR Session("CountryOrigin") = "UAE" Then %>
                      <input type="hidden" name="currency_code" value="USD">
                      <% ElseIf Session("CountryOrigin") = "United Kingdom" Then %>
                      <input type="hidden" name="currency_code" value="GBP">
					   <% ElseIf Session("CountryOrigin") = "Australia" Then %>
...
/* ]]> */
              ...
              <noscript>
              <div style="display:inline;"> <img height="1" width="1" style="border-style:none;" alt="" src="http://www.googleadservices.com/pagead/conversion/1026351431/?label=U-eoCIOU9AEQx8Kz6QM&amp;guid=ON&amp;script=0"/> </div>
              </noscript>
              </p>
            </div>
          </div>
