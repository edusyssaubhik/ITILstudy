...
Set objRs = ConnObj.Execute("SELECT  QuesNo, SelectedChoice, Marked, Duration from SimStrategyTestResponse WHERE TestNo='"&TestNo&"' ORDER BY GID")

'Retrive The Correct Answer Table'
Set objRs1 = ConnObj.Execute("SELECT  QuesNo, Ans, KNo from SimStrategyCorrectAns ORDER BY GID")
...
<%
	...
	If (Not objRs.BOF) AND (Not objRs.EOF) Then
		...
		Set objRs = connObj.Execute("Update  SimStrategyUsertable SET EMail = '"&Session("PayerEmail")&"', KNo1 = "&int(kno1/kno1ques*100)&",KNo2 = "&int(kno2/kno2ques*100)&",KNo3 = "&int(kno3/kno3ques*100)&",KNo4 = "&int(kno4/kno4ques*100)&",KNo5 = "&int(kno5/kno5ques*100)&",KNo6 = "&int(kno6/kno6ques*100)&",OverAll = "&OverAllPercentage&" WHERE TestNo = '"&TestNo&"'")
