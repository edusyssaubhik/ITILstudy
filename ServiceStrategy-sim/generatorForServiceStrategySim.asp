...
ConnObj.Execute ("truncate table SimStrategyCorrectAns")
...
'First PHR'
	...
	For j = 1 to 6
		...
		If a <= 40 Then
			...
			strQuery = "SELECT Question_StrategyDB.QuestionDesc, Question_StrategyDB.CorrectChoice, Question_StrategyDB.Justification, Question_StrategyDB.ExhibitURL ,Choice_StrategyDB.ChoiceNumber, Question_StrategyDB.KNo, Choice_StrategyDB.ChoiceValue FROM Question_StrategyDB, Choice_StrategyDB WHERE  Question_StrategyDB.QuestionNo = '"& m &"' AND Question_StrategyDB.KNo = '"& j &"' AND  Choice_StrategyDB.QuestionNo = '"& m &"' AND Choice_StrategyDB.KNo = '"& j &"' ORDER BY Question_StrategyDB.QuestionNo, Choice_StrategyDB.KNo, Choice_StrategyDB.ChoiceNumber"
			...
			strQuery = "SELECT Question_StrategyDB.QuestionDesc, Question_StrategyDB.CorrectChoice, Question_StrategyDB.Justification, Question_StrategyDB.ExhibitURL ,Choice_StrategyDB.ChoiceNumber, Question_StrategyDB.KNo, Choice_StrategyDB.ChoiceValue FROM Question_StrategyDB, Choice_StrategyDB WHERE Question_StrategyDB.QuestionNo = '"& x &"' AND Question_StrategyDB.KNo = '"& j &"' AND  Choice_StrategyDB.QuestionNo = '"& x &"' AND Choice_StrategyDB.KNo = '"& j &"' ORDER BY Question_StrategyDB.QuestionNo, Choice_StrategyDB.KNo, Choice_StrategyDB.ChoiceNumber"
			...
			If (Not rsQues.BOF) AND (Not rsQues.EOF) Then 
				...
				Do While Not rsQues.EOF
					...
					ConnObj.Execute "INSERT INTO SimStrategyCorrectAns(QuesNo,Kno, Ans) VALUES ('"&a&"','"&Kno&"','"&CorrectChoice&"')"
...
strEnding = strEnding & "<tr><td width="" "">&nbsp;</td><td width="" ""><font face=""Arial,sans-serif"" size=""3"">4 &nbsp;&nbsp; <INPUT TYPE=""radio"" NAME=""SelectedChoice"" VALUE="&ChoiceNumber4&"></font></td><td><font face=""Arial,sans-serif"" size=""3"">"&ChoiceValue4&"</td></tr><tr><td colspan=""3"">&nbsp;</font></td></tr>"
					...
					'Set tsObject = fsoObject.CreateTextFile("E:\vhosts\ITILstudy.com\httpdocs\ServiceStrategy-sim\ServiceStrategySim\"& a &".asp")
					Set tsObject = fsoObject.CreateTextFile("C:\inetpub\wwwroot\ServiceStrategy-sim\ServiceStrategySim\"& a &".asp")
...
strJust = strJust & "<tr><td width="" "">&nbsp;</td><td valign=""top"" colspan=""2""><font face=""Arial,sans-serif"" size=""3"">"&Justification&"</td></tr><tr><td colspan=""3"">&nbsp;</font></td></tr>"
					...
					'Set tsObject = fsoObject.CreateTextFile("E:\vhosts\ITILstudy.com\httpdocs\ServiceStrategy-sim\ServiceStrategySim\"&a&"ans.asp")
					Set tsObject = fsoObject.CreateTextFile("C:\inetpub\wwwroot\ServiceStrategy-sim\ServiceStrategySim\"&a&"ans.asp")
