...
'This page is comes from newUKCalls.asp page'
'======================================================='
...
ConnObj.Execute "INSERT INTO ITIL_callsreceived_new (callfor, callername, phoneno, emailid, callerstate, city, question, call_status1, addeddate, addedby, country, website) VALUES ('"& rqCallFor &"','"& rqCallerName &"','"& rqPhoneNo &"','"& rqEmailId &"','"& rqCounty &"','"& rqCity &"','"& StrQuoteReplace(rqQuestion) &"','1','"& Now() &"','"& Session("USBUserId") &"', 'United Kingdom', 'ITILstudy')"
