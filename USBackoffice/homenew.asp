...
<div id="wrapper">
  ...
  <div id="containerHolder">
    <div id="container">
      ...
      <h2><a href="homenew.asp" class="active">Home</a></h2>
      <div id="main">
        <div>&nbsp;</div>
        <fieldset>
          ...
          <div align="left" style="margin-bottom:40px;">
            <form action="homenew.asp" method="post" onsubmit="return Form_Validator(this)">
              <table>
                <tr>
                  <td>Country: </td>
	...
	' End If
	 ...
	 If Session("CRM_Country") = "US" OR Session("CRM_Country") = "Canada" Then
	   ...
	   If CourseType = "WBT" Then
		 ...
		 If (CourseType <> "Normal" AND CourseType <> "Foundation" AND CourseType <> "WBT" AND CourseType <> "Corporate") Then 
