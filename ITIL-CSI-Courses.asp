    ...
    <% Else %>
     ...
     <% End If %>
            <td width="73%" rowspan="4" background="/images/back/left_line.jpg" class="general-body">
                ...
                <div>
                  <h1 class="PageTitle">ITIL<Sup>&reg;</sup> CSI CLASSES - DATES, LOCATIONS AND PRICES </h1>
...
<br/>
                   ...
                   <table width="97%" border="0" onMouseOut="javascript:highlightTableRowVersionA(0);" id="myTable0" cellpadding="3" cellspacing="0" class="TableGeneral">
					...
					'Sql Query For Retrive dates'
					 ...
					 strQuery = "SELECT Distinct(startdate), enddate FROM ITIL_course WHERE coursetype = 'CSI' and country = '" & Session("CountryOrigin") & "' And startdate >= '"&Now() - 1&"' order by startdate asc"
                   ...
                   <tr>
                      <td valign="top" colspan="6"><form name="frmselections">
                          <table width="60%" border="0" cellspacing="0" cellpadding="0" align="center">
                            <tr>					
					  			<td>
								  <select name="country1" id="country1" style="width:150px;" class="TeXtFielddropdown" onChange="findCountry(this.value,'CSI');clicked1();">
                             	 ...
                             	 <td>
							  		<Select name="location" id="location" style="width:165px" disabled="disabled" class="TeXtFielddropdown"  onChange="findCity1(this.value,'CSI');">
                    ...
                    <tr>
                      <td valign="top" colspan="6"><form name="frmselections">
                          <table width="80%" border="0" cellspacing="0" cellpadding="0" align="center">
                            <tr>
                              <td><select name="location" id="location" style="width:200px;" class="TeXtFielddropdown" onChange="findCity(this.value,'CSI');">
			  ...
			  'Created file includes here 
               ...
               <!-- <div><span class="Required">*</span> : Price after early bird discount (if you enroll and pay more than <%' If Month(Date) = 11 Then %>3<%' Else %><%' = CourseApplicableDays %><%' End If %> days before the course start date, and if seats are available)</div>
                ...
                <p><a href="/enrollClass.asp?coursetype=CSI" class="Header">ENROLL in ITILstudy
