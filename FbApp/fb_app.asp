...
dim FACEBOOK_APP_ID: FACEBOOK_APP_ID = "105992326222704"
dim FACEBOOK_SECRET: FACEBOOK_SECRET = "333488914602f7adbf58db78edcf5538"

dim redicturl
redicturl=session("fbRedirectUrl")
'Session.Contents.Remove("fbRedirectUrl") 'this session not needed anymore
...
dim FACEBOOK_REDIR_URL: FACEBOOK_REDIR_URL = redicturl


session("FACEBOOK_REDIR_URL") = FACEBOOK_REDIR_URL


dim FACEBOOK_SCOPE: FACEBOOK_SCOPE = "email,user_birthday"
