...
If rqCourseId = "" Then
    Response.Redirect("/enrollClass_Manual_swi.asp")
End If
%>
<!-- Body Starts -->
<%
...
Do until objRs.EOF
	...
	If (Session("CountryOrigin") = "United Kingdom" OR Session("CountryOrigin") = "India" OR Session("CountryOrigin") = "Australia") OR Session("CountryOrigin") = "Switzerland" Then
...
'		  End If
        ...
        ElseIf (Session("CountryOrigin") = "Switzerland") Then
			...
			strBody = strBody & "&nbsp;&nbsp;<a href=""http://www.ITILstudy.com/payment-swi.asp?enrollUserID="& Session("EnrollId") &"&Country="& Session("CountryOrigin") &"""><font face=""Arial"" size=""3"" color=""#0359b4""><b>Buy Now</b></font></a></li></ul>"
