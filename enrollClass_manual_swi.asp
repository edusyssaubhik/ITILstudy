       <% Session("CountryOrigin") = "Switzerland"%>
  ...
  <td height="235" align="left" valign="top" bgcolor="#FFFFFF">
   <table width="100%" border="0" cellspacing="0" cellpadding="8">
    ...
    <table width="97%" border="0" cellpadding="0" cellspacing="0" class="general-body">
      <form action="/enrollSuccess-Manual-swi.asp" method="post" onsubmit="return validate_form(this)">
        <tr>
          <td><div style="margin-left:-0;"><span class="Required">
              ...
              <table border="0" cellpadding="3" cellspacing="0" width="100%">
                ...
                <tr>
                  <td colspan="2" ><span class="Note">*This name will appear on all the certificates</span></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td valign="middle"><br />
                    <input type="text" name="employer" id="employer" size="40" class="TeXtField"></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td colspan="2" ><span class="Note">*(Format: CountryCode-Area-Number)e.g.
				 ...
				 <tr>
                  <td ><span class="general-bodyBold">Address:</span></td>
                  <td ><textarea type="text" name="address" id="address" size="40" height="500"></textarea></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td><select name="courseId" id="class" style="width:480px;"  class="TeXtFielddropdown">
                      <% If IsArray(arrAllCourses) Then
						  ...
						  ' If (IsNull(arrAllCourses(27,rowCounter)) ) Then
