...
<br /><br />
        <table width = "60%" border="0" cellpadding="0" cellspacing="0" class="TableGeneral">
           <tr>
				   ...
				   <tr>
                    <td class="TableRowEven" ><a href="/ITIL-CSIdocs/sample papers/sample paper 1 scenarios.pdf" target="_blank">Scenario</a></td>
                   
                    <td class="TableRowEven" ><a href="/ITIL-CSIdocs/sample papers/sample paper 2 scenarios.pdf" target="_blank">Scenario</a></td>
                  </tr>
                    <tr>
                    <td class="TableRowEven" ><a href="/ITIL-CSIdocs/sample papers/sample paper 1 question booklet.pdf" target="_blank">Question</a></td>
                    
                    <td class="TableRowEven" ><a href="/ITIL-CSIdocs/sample papers/sample paper 2 question booklet.pdf	" target="_blank">Question</a></td>
                   
                  </tr>
                   
                  <tr>
                    <td class="TableRowEven" ><a href="/ITIL-CSIdocs/sample papers/sample paper 1 rationale.pdf" target="_blank">Answer and Rationale</a></td>
                    
                    <td class="TableRowEven" ><a href="/ITIL-CSIdocs/sample papers/sample paer 2 ratioanle.pdf" target="_blank">Answer and Rationale</a></td>
