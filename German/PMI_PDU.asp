<!--#include virtual="/German/metatags/PMI_PDU_metatag.html"-->
    ...
    <tr>
      <td height="235" align="left" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="8">
          <tr>
            <td width="2%" >&nbsp;</td>
            <td width="25%">&nbsp;</td>
            <td width="73%" class="breadcrumb">Home &raquo; WARUM UNS &raquo; PMI PDU's </td>
          </tr>
          <tr>
...
<td width="73%" rowspan="4" background="/images/back/left_line.jpg" class="general-body"><div style="margin-top:-12px; width:97%;">
                ...
                <h1 class="PageTitle">VON PMI<sup>&reg;</sup> ANERKANNTE PDUS</h1>
                <p><span class="SubHeader">Von PMI<sup>&reg;</sup> anerkannte PDUs: </span> ITILstudy vergibt 18 PDUs für den ITIL<sup>&reg;</sup> Foundation Zertifizierungskurs – diese PDUs können Sie für Ihre Re-Zertifizierung verwenden.</p>
