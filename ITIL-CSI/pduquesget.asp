            ...
            <td width="73%" rowspan="4" background="/images/back/left_line.jpg" class="general-body">
                ...
                <div>
                  <%
					...
					rsQues1.Open "SELECT CorrectChoice,QuestionNo FROM Question_CSIDB WHERE Question_CSIDB.KNo='"&KNo&"'"
                ...
                <div>
                  ...
                  <form method="post" action="/ITIL-CSI/pduquesget1.asp" target="_blank">
