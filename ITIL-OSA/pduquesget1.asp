...
<table width="40%" border="0" cellpadding="0" cellspacing="0">
    ...
    <FORM METHOD="POST" ACTION="/ITIL-OSA/pduquesget2.asp">
    ...
    <%else
		...
		rsQues.Open "SELECT Question_OSADB.QuestionDesc, Question_OSADB.ExhibitURL ,Choice_OSADB.ChoiceNumber, Choice_OSADB.ChoiceValue from Question_OSADB, Choice_OSADB WHERE Question_OSADB.KNo='"&KNo&"' and Choice_OSADB.KNo='"&KNo&"' and Question_OSADB.QuestionNo='"&sArray(nCurNo,0,0)&"' and Question_OSADB.QuestionNo=Choice_OSADB.QuestionNo Order by Choice_OSADB.ChoiceNumber"
		...
		ChoiceValue4=rsQues("ChoiceValue")%>
            ...
            <tr>
              <td height="84" colspan="2" class="TableRowOdd"><div align="left"><span class="PopupCopy">
                  ...
                  <a href="/ITIL-OSA/pdusindex.asp" onclick="return ExitAlert(this.href);"><input type="button" class="ButtonTest" value="Exit" /></a>
                  </span></td>
            </tr>
          </table>
    </form>
...
%>
    There are no questions
     <a href="/ITIL-OSA/pdusindex.asp"><input type="button" class="ButtonTest" value="Exit" /></a>
    <%End If
%>
    <%Session("PDUArray")=sArray
%>
