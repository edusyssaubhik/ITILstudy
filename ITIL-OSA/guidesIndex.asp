    ...
    <tr>
      <td height="235" align="left" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="8">
          <tr>
            ...
            <td width="73%" class="PageTitle">ITILstudy.com Study Material <a href="/ITIL-OSA/help.asp#Select-Chapter" style="float:right; margin-right:20px;"><img src="/images/buttons/Help.png" height="20px" style="border-color:#FFFFFF" onmouseover="this.src='/images/buttons/help_h.png'" onmouseout="this.src='/images/buttons/Help.png'"></a></td>
          </tr>
          <tr>
            ...
            <td width="73%" rowspan="4" background="/images/back/left_line.jpg" class="general-body"><%
              ...
              <form method="post" action="/ITIL-OSA/guides1.asp">
                <%Dim KNumber, count
				KNumber=kno_passed
				count=0
				%>
