...
rsQues.Open "select KNo, Areatitle from KArea_OSA"%>
                <div>
                  <table width="95%" border="0" cellspacing="3" cellpadding="3" align="left" class="general-body">
                    <form method="post" action="/ITIL-OSA/quessget.asp" target="_blank">
                      <%Dim KNumber, count
...
%>
                      ...
                      <%
					  strQuery ="SELECT COUNT(*) as QuestionNo FROM Question_OSADB  WHERE KNo = '" & Session("KNO") &"' "
                   ...
                   'response.Write(questionNo)
                    ...
                    <tr id="Chapter">
                      ...
                      <tr>
                        <td COLSPAN="2" class="general-body"><% If Session("State") = "verified11" Then	%>
