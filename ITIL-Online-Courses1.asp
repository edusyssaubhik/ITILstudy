...
-->
              ...
              <table width="97%" onMouseOut="javascript:highlightTableRowVersionA(0);" id="myTable0" border="0" cellpadding="0" cellspacing="0">
                <tr onMouseOver="javascript:highlightTableRowVersionA(this, '#FFFFCC');">
                  ...
                  <td class="TableRowEven" colspan="2" ><div align="center"><span class="Header">Online Courses</span></div></td>
                </tr>
			<!-- Free Online test to understand ITIL exam -->
                ...
                <tr onMouseOver="javascript:highlightTableRowVersionA(this, '#FFFFCC');">
                  <td height="108" class="TableRowEven"><a href="/ITILonline.asp?action=30days" target="_blank"><span class="TableCopyName"> ITILstudy ITIL Foundation (Online Course) :</span> <span class="TableCopyDetails"> Priced at
                    ...
                    <% End If %>
                    for 30 Days (This includes E-learning through Study Guides, Chapter Test and podcasts for all chapters) </span></a></td>
                  <% 'CCavenue for India 
				...
				Else %>
                <td class="TableRowEven"><form method="post" action="http://www.pmstudy.com/itil_ccavenue.asp">
                  ...
                  <td class="TableRowEven"><form action="https://www.paypal.com/cgi-bin/webscr" method="post">
                ...
                <% Else %>
                <td class="TableRowOdd"><form method="post" action="http://www.pmstudy.com/itil_ccavenue.asp">
                      <input type=hidden name=Merchant_Id value="t_satpat1848">
                      <%  If Session("CountryOrigin") = "US" OR Session("CountryOrigin") = "Canada" OR Session("CountryOrigin") = "UAE" OR Session("CountryOrigin") = "Singapore" OR Session("CountryOrigin") = "India" OR Session("CountryOrigin") = "Other"  Then %>
                      <input type="hidden" name="Currency" value="USD">
                      <% ElseIf Session("CountryOrigin") = "United Kingdom" Then %>
                  ...
                  <td class="TableRowOdd"><form action="https://www.paypal.com/cgi-bin/webscr" method="post">
                      <input type="hidden" name="cmd" value="_xclick">
                      <input type="hidden" name="business" value="adminsupport@projstudy.com">
                      <input type="hidden" name="item_name" value="ITIL Foundation Online Course">
                      <input type="hidden" name="item_number" value="103">
                ...
                <tr onMouseOver="javascript:highlightTableRowVersionA(this, '#FFFFCC');">
                  ...
                  <td class="TableRowEven" colspan="2" ><div align="center"><span class="Header">Blended Course</span></div></td>
                </tr>
                <tr onMouseOver="javascript:highlightTableRowVersionA(this, '#FFFFCC');">
                  <td height="108" class="TableRowOdd"><span class="TableCopyName"><a href="/ITILblend.asp" target="_blank"> ITILstudy ITIL Foundation (Online Course + Exam Voucher) :</span> <span class="TableCopyDetails">Priced at
                    ...
                    <% End If %>
                    for 90 Days (This includes E-learning through Study Guides, Chapter Test and podcasts for all chapters) &nbsp;
                    <%'If Session("CountryOrigin") = "United Kingdom" Then %>
                    <!--<b> One Exam Retake</b>-->
                    <%'End If%>
                    </span></a><br />
 ...
 -->
            ...
            <div style="width:97%">
              ...
              <a href="/online-termsandcond.asp" target="_blank">Printable Version</a>
              </span>
              <ul type="disc">
