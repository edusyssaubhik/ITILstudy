...
-->
        ...
        <tr onMouseOver="javascript:highlightTableRowVersionA(this, '#FFFFCC');">
           ...
           <td class="TableRowEven" ><div align="center"><span class="Header">Foundation Course</span></div></td>
          </tr>
             ...
             <form action="/customerdetails.asp" method="post">
				...
				<tr onMouseOver="javascript:highlightTableRowVersionA(this, '#FFFFCC');">
                        <td height="108" class="TableRowEven"><span class="TableCopyName"> ITILstudy ITIL Foundation (Online Course) :</span> <span class="TableCopyDetails"> Priced at
                    ...
                    <tr onMouseOver="javascript:highlightTableRowVersionA(this, '#FFFFCC');">
                    <td height="108" class="TableRowOdd"><span class="TableCopyName">ITILstudy ITIL Foundation (Online Course) :</span> <span class="TableCopyDetails">  Priced at
                         <%  If Session("CountryOrigin") = "US" OR Session("CountryOrigin") = "Canada" OR Session("CountryOrigin") = "UAE" OR Session("CountryOrigin") = "Singapore" OR Session("CountryOrigin") = "India"  Then %>
                       <span class="TableCopyCost"> <% = Currency_Format_Front %> 175 <% = Currency_Format_Back %></span>
					     <% ElseIf Session("CountryOrigin") = "United Kingdom" Then %>
						  ...
						  <% End If %>
                        for 60 Days (This includes E-learning through Study Guides, Chapter Test and podcasts for all chapters)</span></td>
                        <% If Session("CountryOrigin") = "India" Then %>
                    <form method="post" action="http://mycatstudy.com/itilstudy_ccavenue.asp" onSubmit="return validate_form(this)">
                      <input type="hidden" name="item_name" value="ITIL Online Course">
                      <input type="hidden" name="item_number" value="102">
                    ...
                    <tr onMouseOver="javascript:highlightTableRowVersionA(this, '#FFFFCC');">
                       ...
                       <span class="TableCopyCost"> <% = Currency_Format_Front %> 225 <% = Currency_Format_Back %></span>
					     <% ElseIf Session("CountryOrigin") = "United Kingdom" Then %>
						  ...
						  <% End If %>
                        for 90 Days (This includes E-learning through Study Guides, Chapter Test and podcasts for all chapters) </span></td>
                        <% If Session("CountryOrigin") = "India" Then %>
                   <form method="post" action="http://mycatstudy.com/itilstudy_ccavenue.asp" onSubmit="return validate_form(this)">
                      <input type="hidden" name="item_name" value="ITIL Online Course">
                      <input type="hidden" name="item_number" value="102	">
			  ...
			  <tr onMouseOver="javascript:highlightTableRowVersionA(this, '#FFFFCC');">
            <td class="TableRowEven" width="60%"><a href="/ITILblend.asp" target="_blank"><img src="/images/buttons/Blended.jpg" ></a></td>
          
           <td class="TableRowEven" ><a href="/ITILblend.asp" target="_blank"><div align="center"><span class="Header">Blended Course</span></div></a></td>
          </tr>
             <!-- <form action="/customerdetails.asp" method="post">
                      <input type="hidden" name="item_number" value="0051">
                      <input type="hidden" name="APMG" value="APMG">
  			 ...
  			 <!--   <tr onMouseOver="javascript:highlightTableRowVersionA(this, '#FFFFCC');">
                    ...
                    <tr onMouseOver="javascript:highlightTableRowVersionA(this, '#FFFFCC');">
                        <td height="108" class="TableRowOdd"><span class="TableCopyName"> ITILstudy ITIL Foundation (E-learning + Exam Voucher) :</span> <span class="TableCopyDetails">Priced at
						  <%  If Session("CountryOrigin") = "US" OR Session("CountryOrigin") = "Canada" OR Session("CountryOrigin") = "UAE" OR Session("CountryOrigin") = "Singapore" OR Session("CountryOrigin") = "India"  Then %>
                       <span class="TableCopyCost"> <% = Currency_Format_Front %> 450 <% = Currency_Format_Back %></span>
					     <% ElseIf Session("CountryOrigin") = "United Kingdom" Then %>
						  ...
						  <% End If %>
                        for 90 Days (This includes E-learning through Study Guides, Chapter Test and podcasts for all chapters) &nbsp;<%If Session("CountryOrigin") = "United Kingdom" Then %><b> One Exam Retake</b><%End If%> </span></td>
                        <% If Session("CountryOrigin") = "India" Then %>
                    <form method="post" action="http://mycatstudy.com/itilstudy_ccavenue.asp" onSubmit="return validate_form(this)">
