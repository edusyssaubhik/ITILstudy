    ...
    <tr>
      <td height="235" align="left" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="8">
          <tr>
            ...
            <td width="73%" class="PageTitle">Chapter Tests <a href="/ServiceTransition/help.asp#chapter-test" style="float:right; margin-right:20px;"><img src="/images/buttons/Help.png" height="20px" style="border-color:#FFFFFF" onmouseover="this.src='/images/buttons/help_h.png'" onmouseout="this.src='/images/buttons/Help.png'"></a></td>
          </tr>
          <tr>
...
rsQues.Open "select KNo, Areatitle from KArea_Transition"%>
                <div>
                  <table width="95%" border="0" cellspacing="3" cellpadding="3" align="left" class="general-body">
                    <form method="post" action="/ServiceTransition/quessget.asp" target="_blank">
                      <%Dim KNumber, count
...
%>
                      ...
                      <%
					  strQuery ="SELECT COUNT(*) as QuestionNo FROM Question_TransitionDB  WHERE KNo = '" & Session("KNO") &"' "
                   ...
                   'response.Write(questionNo)
                     ...
                     <tr id="Chapter">
                      ...
                      <tr>
                        <td COLSPAN="2" class="general-body"><% If Session("State") = "verified15" Then	%>
