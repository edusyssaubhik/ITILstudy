...
<table width="40%" border="0" cellpadding="0" cellspacing="0">
      ...
      <form method="post" action="/ServiceTransition/pduquesget1.asp">
    ...
    <FORM METHOD="POST" ACTION="/ServiceTransition/pduquesget2.asp">
    ...
    <%else
		...
		rsQues.Open "SELECT Question_TransitionDB.QuestionDesc, Question_TransitionDB.ExhibitURL ,Choice_TransitionDB.ChoiceNumber, Choice_TransitionDB.ChoiceValue from Question_TransitionDB, Choice_TransitionDB WHERE Question_TransitionDB.KNo='"&KNo&"' and Choice_TransitionDB.KNo='"&KNo&"' and Question_TransitionDB.QuestionNo='"&sArray(nCurNo,0,0)&"' and Question_TransitionDB.QuestionNo=Choice_TransitionDB.QuestionNo Order by Choice_TransitionDB.ChoiceNumber"
		...
		ChoiceValue4=rsQues("ChoiceValue")%>
            ...
            <tr>
              <td height="84" colspan="2" class="TableRowOdd"><div align="left"><span class="PopupCopy">
                  ...
                  <a href="/ServiceTransition/pdusindex.asp" onclick="return ExitAlert(this.href);"><input type="button" class="ButtonTest" value="Exit" /></a>
                  </span></td>
            </tr>
          </table>
    </form>
...
%>
    There are no questions
     <a href="/ServiceTransition/pdusindex.asp"><input type="button" class="ButtonTest" value="Exit" /></a>
    <%End If
%>
    <%Session("PDUArray")=sArray
%>
