...
rsQues.Open "SELECT Question_TransitionDB.QuestionDesc, Question_TransitionDB.CorrectChoice, Question_TransitionDB.Justification, Question_TransitionDB.ExhibitURL ,Choice_TransitionDB.ChoiceNumber, Choice_TransitionDB.ChoiceValue from Question_TransitionDB, Choice_TransitionDB WHERE Question_TransitionDB.KNo='"&KNo&"' and Choice_TransitionDB.KNo='"&KNo&"' and Question_TransitionDB.QuestionNo='"&QuesAsked&"' and Question_TransitionDB.QuestionNo=Choice_TransitionDB.QuestionNo ORDER by Choice_TransitionDB.ChoiceNumber"
    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td colspan="2" height="84" class="TableRowOdd"><div align="left">
            ...
            <a href="/ServiceTransition/chapterTestsIndex.asp" onclick="return ExitAlert(this.href);"><input type="button" class="ButtonTest" value="Exit" /></a>
          </td>
