...
<table border="1" cellpadding="5" cellspacing="0" align="center" width="45%">
 ...
 <tr>
  <td>
  <form name="addcallsAus" action="addCallsUAE.asp" method="post" onsubmit="return Form_Validator(this)">
...
<tr>
	 ...
	 <td>  <select name="state">
	  ...
	  <%
	  'Retrive the states'
		strAUSState = "SELECT state, state_code FROM ITIL_city WHERE country = 'UAE' ORDER BY state"
