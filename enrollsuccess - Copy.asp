...
'		  End If
		 ...
		 If (Session("CountryOrigin") = "US" OR Session("CountryOrigin") = "Canada" OR Session("CountryOrigin") = "UAE" OR Session("CountryOrigin") = "Singapore" OR Session("CountryOrigin") = "United Kingdom" OR Session("CountryOrigin") = "Australia" OR Session("CountryOrigin") = "Germany" OR Session("CountryOrigin") = "Netherlands") Then
		  ...
		  strBody = strBody & "<ul><li><font face=""Arial"" size=""2""><b>Bank Transfer:</b></font><br/>"
		  strBody = strBody & "Client:Edusys Services GmbH i.Gr.<br/>Account No.:040394900<br/>Branch:Deutsche Bank Privat- und Geschäftskunden AG, Hanau<br/>IBAN:DE47 5067 0024 0040 3949 00<br/>SWIFT-Code:DEUTDEDB506</li></ul>"
    ...
    End If
		 ...
		 Else 
		  ...
		  ElseIf Session("CountryOrigin") = "Germany" Then
		   ...
		   strBody = strBody & "EDUsys Services GmbH<br>Kurt-Blaum-Platz 8, 63490 Hanau/Frankfurt-Main, Germany"
   ...
   <% Else %>
    ...
    <table width="97%" border="0" cellpadding="0" cellspacing="0" class="general-body">
      ...
      <% End If
		 End If %>
      <tr>
        <td colspan="2" class="general-body"><b>Please Note: </b>
