...
If  TestNo = "" Then
	...
	ConnObj.Execute "INSERT INTO CSIsample8Quesusertable(EMail, LastName, FirstName) VALUES ('"&PayerEmail&"', '"&LastName&"','"&FirstName&"')"	
	
	Set rsQues = Server.CreateObject("ADODB.Recordset")
	rsQues.ActiveConnection = connObj
	
	'Retrive The Maximum Test Number Based On Email ID'
	rsQues.Open "SELECT TestNo from CSIsample8Quesusertable WHERE EMail='"&PayerEmail&"' order by TestNo Desc"
