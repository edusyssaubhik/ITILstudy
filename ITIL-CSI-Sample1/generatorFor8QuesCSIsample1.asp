...
ConnObj.Execute ("truncate table CSIsample8QuesCorrectAns")
...
'Fifth SIM
		...
		If e <= 8 Then
			...
			strQuery = "SELECT Question_CSIsample1.QuestionDesc, Question_CSIsample1.Question, Question_CSIsample1.CorrectChoice, Question_CSIsample1.Justification,Choice_CSIsample1.ChoiceNumber,  Choice_CSIsample1.ChoiceValue , Choice_CSIsample1.ChoiceRate FROM Question_CSIsample1, Choice_CSIsample1 WHERE Question_CSIsample1.QuestionNo = '"& m &"' AND  Choice_CSIsample1.QuestionNo = '"& m &"' ORDER BY Question_CSIsample1.QuestionNo, Choice_CSIsample1.ChoiceNumber"
				m = m + 1
			...
			If (Not rsQues.BOF) AND (Not rsQues.EOF) Then
				...
				Do While Not rsQues.EOF
					...
					ConnObj.Execute "INSERT INTO CSIsample8QuesCorrectAns(QuesNo, Ans) VALUES ('"&e&"','"&CorrectChoice&"')"
...
strEnding = strEnding & "<tr><td width="" "">&nbsp;</td><td width="" ""><font face=""Arial,sans-serif"" size=""3"">4 &nbsp;&nbsp; <INPUT TYPE=""radio"" NAME=""SelectedChoice"" VALUE="&ChoiceNumber4&"></font></td><td><font face=""Arial,sans-serif"" size=""3"">"&ChoiceValue4&"</td></tr><tr><td colspan=""3"">&nbsp;</font></td></tr>"
					...
					'Set tsObject = fsoObject.CreateTextFile("C:\Inetpub\wwwroot\FoundationSims\sim15Ques\"& e&".asp")
						Set tsObject = fsoObject.CreateTextFile("C:\Inetpub\wwwroot\ITIL-CSI-Sample1\sample8Ques\"&e&".asp")
						'Set tsoObject = fsoObject.CreateTextFile("E:\vhosts\ITILstudy.com\httpdocs\ITIL-CSI-Sample1\sample8Ques\"&e&".asp")
...
strJust = strJust & "<tr><td width="" "">&nbsp;</td><td valign=""top"" colspan=""2""><font face=""Arial,sans-serif"" size=""3"">"&Justification&"</td></tr><tr><td colspan=""3"">&nbsp;</font></td></tr>"
					...
					'Set tsObject = fsoObject.CreateTextFile("C:\Inetpub\wwwroot\FoundationSims\sim15Ques\"&e&"ans.asp")
						Set tsObject = fsoObject.CreateTextFile("C:\Inetpub\wwwroot\ITIL-CSI-Sample1\sample8Ques\"&e&"ans.asp")
						'Set tsoObject = fsoObject.CreateTextFile("E:\vhosts\ITILstudy.com\httpdocs\ITIL-CSI-Sample1\sample8Ques\"&e&".asp")
