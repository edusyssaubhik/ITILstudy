            ...
            <td width="73%" rowspan="4" background="/images/back/left_line.jpg" class="general-body">
                ...
                <div>
                  <%
					...
					rsQues1.Open "SELECT CorrectChoice,QuestionNo FROM Question_PPODB WHERE Question_PPODB.KNo='"&KNo&"'"
                ...
                <div>
                  ...
                  <form method="post" action="/ITIL-PPO/pduquesget1.asp" target="_blank">
