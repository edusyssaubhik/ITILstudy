...
<table width="40%" border="0" cellpadding="0" cellspacing="0">
      ...
      <form method="post" action="/ITIL-PPO/pduquesget1.asp">
    ...
    <FORM METHOD="POST" ACTION="/ITIL-PPO/pduquesget2.asp">
    ...
    <%else
		...
		rsQues.Open "SELECT Question_PPODB.QuestionDesc, Question_PPODB.ExhibitURL ,Choice_PPODB.ChoiceNumber, Choice_PPODB.ChoiceValue from Question_PPODB, Choice_PPODB WHERE Question_PPODB.KNo='"&KNo&"' and Choice_PPODB.KNo='"&KNo&"' and Question_PPODB.QuestionNo='"&sArray(nCurNo,0,0)&"' and Question_PPODB.QuestionNo=Choice_PPODB.QuestionNo Order by Choice_PPODB.ChoiceNumber"
		...
		ChoiceValue4=rsQues("ChoiceValue")%>
            ...
            <tr>
              <td height="84" colspan="2" class="TableRowOdd"><div align="left"><span class="PopupCopy">
                  ...
                  <a href="/ITIL-PPO/pdusindex.asp" onclick="return ExitAlert(this.href);"><input type="button" class="ButtonTest" value="Exit" /></a>
                  </span></td>
            </tr>
          </table>
    </form>
...
%>
    There are no questions
     <a href="/ITIL-PPO/pdusindex.asp"><input type="button" class="ButtonTest" value="Exit" /></a>
    <%End If
%>
    <%Session("PDUArray")=sArray
%>
