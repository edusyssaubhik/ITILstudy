...
var r=confirm("Are you sure you want quit the chapter test?");
	...
	if (r==true) {
		top.location.href='/chapterTestsIndex.asp';
	}
	else {
		return false;
	}
...
rsQues.Open "SELECT Question_PPODB.QuestionDesc, Question_PPODB.CorrectChoice, Question_PPODB.Justification, Question_PPODB.ExhibitURL ,Choice_PPODB.ChoiceNumber, Choice_PPODB.ChoiceValue from Question_PPODB, Choice_PPODB WHERE Question_PPODB.KNo='"&KNo&"' and Choice_PPODB.KNo='"&KNo&"' and Question_PPODB.QuestionNo='"&QuesAsked&"' and Question_PPODB.QuestionNo=Choice_PPODB.QuestionNo ORDER by Choice_PPODB.ChoiceNumber"
    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td colspan="2" height="84" class="TableRowOdd"><div align="left">
            ...
            <a href="/chapterTestsIndex.asp" onclick="return ExitAlert(this.href);"><input type="button" class="ButtonTest" value="Exit" /></a>
          </td>
