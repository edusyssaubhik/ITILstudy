...
<table width="930" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="8">
    <tr>
      ...
      <td width="73%" class="PageTitle">Service Operation Sample Papers<a href="/ITIL/help.asp#APMG-sample-paper" style="float:right; margin-right:20px;"><img src="/images/buttons/Help.png" height="20px" style="border-color:#FFFFFF" onmouseover="this.src='/images/buttons/help_h.png'" onmouseout="this.src='/images/buttons/Help.png'"></a></td>
    </tr>
    <tr>
...
<br /><br />
        <table width = "75%" border="0" cellpadding="0" cellspacing="0" class="TableGeneral">
           <tr>
                    <td class="TableRowOdd"><b>Service Operation Sample Paper1</b></td>
                    <td class="TableRowOdd"><b>Service Operation Sample Paper2</b></td>
                    
                  </tr>
				  
				   <tr>
                    <td class="TableRowEven" ><a href="/ServiceOperationDocs/SOpapers/SOpaper1-scenarios.pdf" target="_blank">Scenario</a></td>
                   
                    <td class="TableRowEven" ><a href="/ServiceOperationDocs/SOpapers/SOpaper2-scenarios.pdf" target="_blank">Scenario</a></td>
                  </tr>
                    <tr>
                    <td class="TableRowEven" ><a href="/ServiceOperationDocs/SOpapers/SOpaper1-questions.pdf" target="_blank">Question</a></td>
                    
                    <td class="TableRowEven" ><a href="/ServiceOperationDocs/SOpapers/SOpaper2-questions.pdf	" target="_blank">Question</a></td>
                   
                  </tr>
                   
                  <tr>
                    <td class="TableRowEven" ><a href="/ServiceOperationDocs/SOpapers/SOpaper1-answers.pdf" target="_blank">Answer and Rationale</a></td>
                    
                    <td class="TableRowEven" ><a href="/ServiceOperationDocs/SOpapers/SOpaper2-answers.pdf" target="_blank">Answer and Rationale</a></td>
