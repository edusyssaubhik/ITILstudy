...
<table width="40%" border="0" cellpadding="0" cellspacing="0">
      ...
      <form method="post" action="/ServiceOperation/pduquesget1.asp">
    ...
    <FORM METHOD="POST" ACTION="/ServiceOperation/pduquesget2.asp">
    ...
    <%else
		...
		rsQues.Open "SELECT Question_OperationDB.QuestionDesc, Question_OperationDB.ExhibitURL ,Choice_OperationDB.ChoiceNumber, Choice_OperationDB.ChoiceValue from Question_OperationDB, Choice_OperationDB WHERE Question_OperationDB.KNo='"&KNo&"' and Choice_OperationDB.KNo='"&KNo&"' and Question_OperationDB.QuestionNo='"&sArray(nCurNo,0,0)&"' and Question_OperationDB.QuestionNo=Choice_OperationDB.QuestionNo Order by Choice_OperationDB.ChoiceNumber"
		...
		ChoiceValue4=rsQues("ChoiceValue")%>
            ...
            <tr>
              <td height="84" colspan="2" class="TableRowOdd"><div align="left"><span class="PopupCopy">
                  ...
                  <a href="/ServiceOperation/pdusindex.asp" onclick="return ExitAlert(this.href);"><input type="button" class="ButtonTest" value="Exit" /></a>
                  </span></td>
            </tr>
          </table>
    </form>
...
%>
    There are no questions
     <a href="/ServiceOperation/pdusindex.asp"><input type="button" class="ButtonTest" value="Exit" /></a>
    <%End If
%>
    <%Session("PDUArray")=sArray
%>
