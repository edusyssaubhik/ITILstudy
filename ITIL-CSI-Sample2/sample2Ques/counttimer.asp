...
<%
	 ...
	 If Session("payerEmail") <> "" Then
		...
		Else
			...
			Set objRs = connObj.Execute("SELECT SUM(Duration) AS TimeTaken FROM CSIsample2QuesResponse WHERE TestNo = '"& Session("TestNo") & "'")
    ...
    <table width="955" border="0" cellspacing="0" cellpadding="3" height="40px">
      <tr>
        ...
        <td colspan="2" bgcolor="#000066"><div align="center" class="">
            <font color="#FFFFFF" face="Arial, Helvetica, sans-serif" size="3"><strong>CSI Sample Paper 2</strong></font></div></td>
