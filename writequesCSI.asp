...
rsQues.Open "SELECT Question_CSIDB.QuestionDesc, Question_CSIDB.CorrectChoice, Question_CSIDB.Justification, Question_CSIDB.ExhibitURL ,Choice_CSIDB.ChoiceNumber, Choice_CSIDB.ChoiceValue from Question_CSIDB, Choice_CSIDB WHERE Question_CSIDB.KNo='"&KNo&"' and Choice_CSIDB.KNo='"&KNo&"' and Question_CSIDB.QuestionNo='"&QuesNo&"' and Question_CSIDB.QuestionNo=Choice_CSIDB.QuestionNo ORDER by Choice_CSIDB.ChoiceNumber"
If Not rsQues.BOF Then%>
<P align="center"><B>View/Edit/Add given question:</B><BR><BR></P>
<B><U>View Question:</U></B>&nbsp;&nbsp;&nbsp;<B><a href="./writequesCSI.asp">Home Page</A></B>
<form method="post" action="./writequesCSI.asp">
...
<P align="center"><B>View/Edit/Add given question:</B><BR><BR></P>
Information updated in database<B><U>View Question:</U></B>&nbsp;&nbsp;&nbsp;<B><a href="./writequesCSI.asp">Home Page</A></B>
<%
QuesNo=Request.Form("QuesNo")
KNo=Request.Form("KNo")
QuesNoPrev=int(QuesNo)-1%>
...
connObj.Execute "INSERT INTO Question_CSIDB (QuestionNo, KNo, QuestionDesc, CorrectChoice, Justification) VALUES ('"&quesno&"','"&kno&"','"&questiondesc&"','"&correctchoice&"','"&justification&"')"
connObj.Execute "INSERT INTO Choice_CSIDB(QuestionNo, ChoiceNumber,ChoiceValue,KNo) VALUES ('"&quesno&"','"&choice1&"','"&choicevalue1&"','"&kno&"')"
connObj.Execute "INSERT INTO Choice_CSIDB(QuestionNo, ChoiceNumber,ChoiceValue,KNo) VALUES ('"&quesno&"','"&choice2&"','"&choicevalue2&"','"&kno&"')"
connObj.Execute "INSERT INTO Choice_CSIDB(QuestionNo, ChoiceNumber,ChoiceValue,KNo) VALUES ('"&quesno&"','"&choice3&"','"&choicevalue3&"','"&kno&"')"
connObj.Execute "INSERT INTO Choice_CSIDB(QuestionNo, ChoiceNumber,ChoiceValue,KNo) VALUES ('"&quesno&"','"&choice4&"','"&choicevalue4&"','"&kno&"')"
addoredit="edit"
else
Response.Write("I am in Edit")
connObj.Execute "update Question_CSIDB Set QuestionDesc='"&questionDesc&"', Justification='"&Justification&"', CorrectChoice='"&CorrectChoice&"' Where kno='"&kno&"' and QuestionNo='"&quesno&"'"
connObj.Execute "update Choice_CSIDB Set ChoiceValue='"&ChoiceValue1&"' Where kno='"&kno&"' and questionno='"&quesno&"' and ChoiceNumber='"&choice1&"'"
connObj.Execute "update Choice_CSIDB Set ChoiceValue='"&ChoiceValue2&"' Where kno='"&kno&"' and questionno='"&quesno&"' and ChoiceNumber='"&choice2&"'"
connObj.Execute "update Choice_CSIDB Set ChoiceValue='"&ChoiceValue3&"' Where kno='"&kno&"' and questionno='"&quesno&"' and ChoiceNumber='"&choice3&"'"
connObj.Execute "update Choice_CSIDB Set ChoiceValue='"&ChoiceValue4&"' Where kno='"&kno&"' and questionno='"&quesno&"' and ChoiceNumber='"&choice4&"'"
...
<P align="center"><B>View/Edit/Add given question:</B><BR><BR></P>
<%QuesNo=Request.Form("QuesNo")%>
Question <%=QuesNo%> deleted from database<B><U>View Question:</U></B><form method="post" action="./writequesCSI.asp">
<%
KNo=Request.Form("KNo")
QuesNoPrev=int(QuesNo)-1%>
<input type="hidden" name="QuesNo" value="<%=QuesNoPrev%>">
...
connObj.Execute "delete from Question_CSIDB Where kno='"&kno&"' and QuestionNo='"&quesno&"'"
connObj.Execute "delete from Choice_CSIDB Where kno='"&kno&"' and questionno='"&quesno&"'"
...
<BR><BR>
 ...
 <%Else
  ...
  Response.Redirect("/access_CSIques.asp")
