...
rsQues.Open "SELECT Question_CSIsample2.QuestionDesc, Question_CSIsample2.Question, Question_CSIsample2.CorrectChoice, Question_CSIsample2.Justification, Choice_CSIsample2.ChoiceNumber, Choice_CSIsample2.ChoiceValue, Choice_CSIsample2.ChoiceRate from Question_CSIsample2, Choice_CSIsample2 WHERE Question_CSIsample2.QuestionNo='"&QuesNo&"' and Question_CSIsample2.QuestionNo=Choice_CSIsample2.QuestionNo ORDER by Choice_CSIsample2.ChoiceNumber"

If Not rsQues.BOF Then%>
<P align="center"><B>View/Edit/Add given question:</B><BR><BR></P>
<B><U>View Question:</U></B>&nbsp;&nbsp;&nbsp;<B><a href="./writequesCSI_Sample2.asp">Home Page</A></B>
<form method="post" action="./writequesCSI_Sample2.asp">
...
<P align="center"><B>View/Edit/Add given question:</B><BR><BR></P>
Information updated in database<B><U>View Question:</U></B>&nbsp;&nbsp;&nbsp;<B><a href="./writequesCSI_Sample2.asp">Home Page</A></B>
<%
QuesNo=Request.Form("QuesNo")
KNo=Request.Form("KNo")
QuesNoPrev=int(QuesNo)-1%>
...
connObj.Execute "INSERT INTO Question_CSIsample2 (QuestionNo, QuestionDesc, Question, CorrectChoice, Justification) VALUES ('"&quesno&"','"&questiondesc&"','"&question&"','"&correctchoice&"','"&justification&"')"
connObj.Execute "INSERT INTO Choice_CSIsample2(QuestionNo, ChoiceNumber,ChoiceValue,ChoiceRate) VALUES ('"&quesno&"','"&choice1&"','"&choicevalue1&"','"&ChoiceRate1&"')"
connObj.Execute "INSERT INTO Choice_CSIsample2(QuestionNo, ChoiceNumber,ChoiceValue,ChoiceRate) VALUES ('"&quesno&"','"&choice2&"','"&choicevalue2&"','"&ChoiceRate2&"')"
connObj.Execute "INSERT INTO Choice_CSIsample2(QuestionNo, ChoiceNumber,ChoiceValue,ChoiceRate) VALUES ('"&quesno&"','"&choice3&"','"&choicevalue3&"','"&ChoiceRate3&"')"
connObj.Execute "INSERT INTO Choice_CSIsample2(QuestionNo, ChoiceNumber,ChoiceValue,ChoiceRate) VALUES ('"&quesno&"','"&choice4&"','"&choicevalue4&"','"&ChoiceRate4&"')"
addoredit="edit"
else
Response.Write("I am in Edit")
connObj.Execute "update Question_CSIsample2 Set QuestionDesc='"&questionDesc&"', Question='"&question&"', Justification='"&Justification&"', CorrectChoice='"&CorrectChoice&"' Where QuestionNo='"&quesno&"'"
connObj.Execute "update Choice_CSIsample2 Set ChoiceValue='"&ChoiceValue1&"' , ChoiceRate='"&ChoiceRate1&"' Where  questionno='"&quesno&"' and ChoiceNumber='"&choice1&"'"
connObj.Execute "update Choice_CSIsample2 Set ChoiceValue='"&ChoiceValue2&"' , ChoiceRate='"&ChoiceRate2&"' Where  questionno='"&quesno&"' and ChoiceNumber='"&choice2&"'"
connObj.Execute "update Choice_CSIsample2 Set ChoiceValue='"&ChoiceValue3&"' , ChoiceRate='"&ChoiceRate3&"' Where  questionno='"&quesno&"' and ChoiceNumber='"&choice3&"'"
connObj.Execute "update Choice_CSIsample2 Set ChoiceValue='"&ChoiceValue4&"' , ChoiceRate='"&ChoiceRate4&"' Where questionno='"&quesno&"' and ChoiceNumber='"&choice4&"'"
...
<P align="center"><B>View/Edit/Add given question:</B><BR><BR></P>
<%QuesNo=Request.Form("QuesNo")%>
Question <%=QuesNo%> deleted from database<B><U>View Question:</U></B><form method="post" action="./writequesCSI_Sample2.asp">
<%
QuesNoPrev=int(QuesNo)-1%>
<input type="hidden" name="QuesNo" value="<%=QuesNoPrev%>">
<input type="hidden" name="submitvalue" value="Initialize">
...
connObj.Execute "delete from Question_CSIsample2 Where  QuestionNo='"&quesno&"'"
connObj.Execute "delete from Choice_CSIsample2 Where  questionno='"&quesno&"'"
...
<BR><BR>
 ...
 <%Else
  ...
  Response.Redirect("/access_CSIsample2.asp")
