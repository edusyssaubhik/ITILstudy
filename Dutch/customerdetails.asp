...
<tr>
  ...
  <% else %>
    <td width="73%" class="PageTitle">INSCHRIJVING VOOR KLANTEN</td>  
  <% End if %>
</tr>
<tr>
        <%
...
<div style="margin-top:-10px; width:95%;">
 ...
 <%
 					'Declare The Local Variables'
						...
						SIPAddress1 = Request.ServerVariables("HTTP_X_FORWARDED_FOR")
							...
							Redirect_Url =	"http://www.ITILstudy.com/Dutch/customerdetails.asp"	'Your Return URL where your customer will be redirected after authorisation from 	CCAvenue
 ...
 <div><% If Request.Form("item_number")="" And session("Newitem_number")="" And Request.Form("address_street")="" And Auth_Status = "N" Then %>
  ...
  <div class="general-body"><br /><br />Your payment was not successful. If you are finding difficulty in paying through <a href="/Dutch/ITIL-Online-Courses-nl.asp">Paypal.com</a>, please make the payment through our alternate payment processor, Google Checkout: <a href="/Dutch/ITIL-Online-Courses-nl.asp">Please click here to pay using </a> Google Checkout. Please note that payment from all countries can be made through Google Checkout.
<% else %>
					  </div>
...
<table width="95%" border="0" cellspacing="0" cellpadding="4" class="general-body">
            <form method="POST" action="" name="form2" onSubmit="return validate_form(this)" id="form2">
              <tr>
                <td><span class="general-bodyBold">Bevestig uw naam</span><span class="Required">*</span> <b>:</b> 
                  </td>
                <td>			
                 <%
				 						'code by me		======================				
	'Declare The Local Variables'
						...
						Dim rqModeOfPayment,rqPaymentdate,rqTraDetails
							 ...
							 Session.Contents.Remove("returnUrl") 'need to be removed if user is logged in
                               ...
                               if session("FirstName")="" then
								Response.redirect("/Dutch/ITIL-Online-Courses.asp")
                               end if	
              ...
              <tr>
                <td colspan="2">
                  <span class="Header">Voer uw e-mailadres en wachtwoord in voor toegang tot verschillende diensten van ITILstudy.com.</span> </td>
              </tr>
              <% If(payer_email<>"") then %>
              <tr valign="top">
               <!-- <td class="general-bodyBold" >Email<span class="Required">*</span>: </td> commented by chandan
				...
				<% if Request.Form("address_street")<>"" then 'this condition will be true only for paypal return and we will show submit button
				%>
				 <td class="general-bodyBold" >E-mailadres (ID gebruiker)<span class="Required">*</span>: </td>
				<% else%>
                <td class="general-bodyBold" >Naam werknemer / bedrijf<span class="Required">*</span>: </td>
				<% end if%>
             ...
             <!-- <input type="hidden" name="payer_email" value="<%=payer_email%>" size="250">-->
              ...
              <tr>
                <td class="general-bodyBold">Telefoonnummer<span class="Required">*</span>: </td>
                <td>
				...
				<tr>
              <td><b>Land<span class="Required">*</span>:</b></td>
              <td><input type="text" name="country" value="<%=country%>" /></td>
            </tr>
              <tr>
              <td><b>Provincie<span class="Required">*</span>:</b></td>
              <td><input type="text" name="state"  /></td>
            </tr>
            <tr>
              <td><b>Stad<span class="Required">*</span>:</b></td>
     ...
     <option value="" >--Select--</option>
      ...
      <option value="India">India</option>
			  ...
			  %>
              <tr>
			  	<td colspan="2"><span class="Note" style="font-size:10px;">(Vorm: landcode-netnummer) bijv. 0031-13-7893647</span></td>
			  </tr>
              <tr>
                 <td class="general-bodyBold">Speciale verzoeken (indien van toepassing): </td>
              </tr>
              <tr>
                 <td class="general-bodyBold">Diëten: </td>
                 <td><input type="text" name="dietary" size="50" maxlength="500" class="TeXtField"></td>
              </tr>
              <tr>
                 <td class="general-bodyBold">Mobiliteit:</td>
                 <td><input type="text" name="mobility" size="50" maxlength="200" class="TeXtField"></td>
              </tr>	
              <tr>
                 <td class="general-bodyBold">Lezen, schrijven: </td>
                 <td><input type="text" name="reaORwrit" size="50" maxlength="200" class="TeXtField"></td>
              </tr>	
               <tr>
                 <td class="general-bodyBold">Horen:</td>
                 <td><input type="text" name="audio" size="50" maxlength="500" class="TeXtField"></td>
              </tr>			  		  		  
               <tr>
                 <td class="general-bodyBold">Anders:</td>
              ...
              <tr>
				...
				<% if Request.Form("address_street")<>"" then 'this condition will be true only for paypal return and we will show submit button
				%>
				 <% form_url="/Dutch/Verifycustomerdetails.asp"%>
				<td>
		...
		$(this).parents('tr:first').find('td:first').remove()
            ...
            <tr>
              <td colspan="2" class="general-body">
                <span class="general-bodyBold">Let op:</span> Indien u uw ID gebruiker niet reset,
                <ul>
                  <li><span class="general-bodyBold">Standaard ID gebruiker / e-mailadres:</span> Dit is het e-mailadres dat u gebruikt voor PayPal.</li>
