    ...
    <tr>
      <td height="235" align="left" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="8">
          <tr>
            ...
            <td width="73%" class="PageTitle">UW WACHTWOORD VERANDEREN</td>
          </tr>
          <tr>
...
%>
                  <form method="POST" action="/Dutch/changepassword-nl.asp" onSubmit="return Form_Validator(this)">
                    ...
                    <tr valign="top">
                      <td><span class="general-bodyBold">E-mailadres / ID gebruiker :</span></td>
                    ...
                    <tr valign="top">
                      <td ><span class="general-bodyBold">Huidig wachtwoord :</span></td>
                      <td align="left" valign="middle" height="14"><input type="password" name="passold" maxlength="10" size="10" class="TeXtField"></td>
                    </tr>
                    <tr valign="top">
                      <td ><span class="general-bodyBold">Nieuw wachtwoord :</span></td>
                      <td align="left" valign="middle" height="14"><input type="password" name="passnew1" maxlength="10" size="10" class="TeXtField">
                        &nbsp;lengte : 10, alleen cijfers en letters zijn toegestaan</td>
                    </tr>
                    <tr valign="top">
                      <td ><span class="general-bodyBold">Nogmaals het nieuwe wachtwoord :</span></td>
...
<tr>
 <td colspan="2">
   <p class="general-bodyBold">Uw wachtwoord is bijgewerkt. <a href="./memberlogin.asp">Log in om door te gaan</a></p>
 </td>
</tr>
<%
	else	
...
%>
<tr>
   <td colspan=2><span class="Error">Sorry, uw gebruikersnaam en wachtwoord zijn niet geldig. Geef weer :</span></td>
</tr><%
End if
else
...
<tr>
 <td colspan="2">
   <p class="general-bodyBold">Je bent ingeschreven througth facebook. Ga naar Login en klik op de knop Flogin</p>
 </td>
</tr>
<%
End if
...
'end of code=============================
                  ...
                  <form method="POST" action="/dutch/changepassword-nl.asp" onSubmit="return Form_Validator(this)">
                    <input type="hidden" name="changepass" value="two">
                    <tr>
                      <td colspan="2" ><span class="Header">WACHTWOORD VERGETEN</span></td>
                    </tr>
                    <tr>
                      <td colspan="2">&nbsp;</td>
                    </tr>
...
%>
                  <form method="POST" action="/dutch/changepassword-nl.asp" onSubmit="return Form_Validator(this)">
                    ...
                    <tr>
                      <td colspan=2><span class="Error">Sorry, uw nieuwe en oude wachtwoord komen niet overeen, gelieve opnieuw te :</span> </td>
                    </tr>
                    <tr>
                      <td colspan="2">&nbsp;</td>
                    </tr>
                ...
                <br>
                <div>
                  <p class="general-body"> Neem voor een verdere verduidelijking of problemen<a href="/Dutch/contactus-nl.asp"> contact op met ITILstudy.com</a> </p>
                </div>
