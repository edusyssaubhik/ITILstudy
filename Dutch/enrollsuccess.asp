...
<!--#include virtual="/includes/headermetaDutchDD.asp"-->
...
If rqCourseId = "" Then
    Response.Redirect("/Dutch/enrollClass.asp")
End If
%>
<!-- Body Starts -->
<%
...
<table width="930" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="8">
   ...
   <% Else %>
      <td width="73%" class="PageTitle"><h1 class="PageTitle">PROGRAMMA BOEKEN ITILSTUDY FOUNDATION</h1>
    <% End If %></td>
    </tr>
    <tr>
    ...
    <table width="97%" border="0" cellpadding="0" cellspacing="0" class="general-body">
      <tr>
        <td colspan="2" align="center" class="general-body"><br />
          <div align="center"><span class="Header">
            ...
            <br />
            <% Else %>
            GEGEVENS INSCHRIJVING OPLEIDING (FACTUUR) ITILstudy Programma boeken met niet-goed-geld-terug-garantie </span>
            <% End If %>
            <% Else %>
            <br />
      ...
      <tr>
        <td class="general-body"><span class="general-bodyBold">ID inschrijving:</span>
          <% = Session("EnrollId") %></td>
      </tr>
      <tr>
        <td class="general-body"><span class="general-bodyBold">Naam: </span>
          <% = Session("FirstName") %>
          &nbsp;
          <% =  Session("LastName") %></td>
      </tr>
      <tr>
        <td class="general-body"><span class="general-bodyBold">E-mailadres: </span>
          <% = Session("Email") %></td>
      </tr>
      <tr>
        <td class="general-body"><span class="general-bodyBold">Telefoonnummer: </span>
          <% = Session("PhoneNumber") %></td>
      </tr>
      <tr>
        <td class="general-body"><span class="general-bodyBold">Naam werkgever / bedrijf: </span>
          <% = Session("NameOfEmployeer") %></td>
      </tr>
      <tr>
        <td colspan="2" class="general-body"><br>
          <span class="Header">Gegevens van uw opleiding en betaling:  </span><br>
          <br />
          <table border="0" width="95%" cellspacing="0" class="TableGeneral">
            <tr>
              <td align="center" class="TableRowOdd" width="85%"><span class="HeaderLarge">Gegevens</span></td>
              <td align="center" class="TableRowOdd"><span class="HeaderLarge">Betaling</span></td>
            </tr>
            <tr>
             <% If rqClasstype = "CSI" OR rqClasstype = "OSA" OR rqClasstype = "ST" Then %>
              <td class="TableRowEven"><span class="TableCopyName">ITIL<sup>&reg;</sup> Intermediate <% = rqClasstype %> Classroom Training <br />
             <% Else %>
              <td class="TableRowEven"><span class="TableCopyName">ITIL<sup>&reg;</sup> Foundation <% = rqCourseType %> boekopleiding  <br />
              <% End If %>
                <% = CourseDetails %>
                </span><br>
              </td>
            ...
            <%End If%>
            <tr>
              <td align="right" class="Tablefooter"><span class="TableCopyName">Totaal</span></td>
                <% If TotalFBdis <> "" Then %>
      ...
      <% End If
		 End If %>
      <tr>
        <td colspan="2" class="general-body"><strong>Let op: </strong><br>
	 Volledige betaling van de inschrijfkosten <strong>(
          <% = Currency_Format_Front %>
            <% If TotalFBdis <> "" Then %> 
           <% = FormatNumber(TotalFBdis) %>
            <% Else %>
          ...
          <% End If %>
          <% = Currency_Format_Back %>
          )</strong> dient te worden gedaan via:  <br />
...
We have reserved a place for you in this course. However, your participation will be confirmed once we receive the payment - otherwise, your registration for this program will be cancelled.</span>
          ...
          <span>We hebben een plaats voor deze opleiding voor u gereserveerd. U dient de betaling binnen
          <% If(CDate(StartDate)-(Date()-1)>5) Then%>
          5 dagen na vandaag over te maken, d.w.z. voor zaterdag
          ...
          <% End If %>
          Indien u dit niet doet, zal uw registratie voor dit lesprogramma komen te vervallen.
            <%end If %>
        </td>
      </tr>
      <tr>
        <td colspan="2" class="general-body"><p> Een kopie van de factuur is tevens naar uw e-mailadres gestuurd. Bekijk uw e-mail, d.w.z.
            <% = Session("Email") %>
            (houd er rekening mee dat de e-mail wellicht in uw map met ongewenste e-mail of prullenbak is beland). Voor vragen of verdere verduidelijking kunt u contact met ons opnemen via marketing@ITILstudy.com.          <p> </td>
      </tr>
      <tr>
        <td colspan="2" class="general-body">
           ITILstudy biedt een niet-goed-geld-terug-garantie voor haar boekprogramma's. Bezoek voor meer informatie www.ITILstudy.com/ITIL-Training/moneyBack.asp. U kunt ook de algemene voorwaarden voor de boekopleidingen van ITILstudy raadplegen op www.ITILstudy.com/termsAndConditions.asp<br />
          
            <p>ITILstudy biedt een niet-goed-geld-terug-garantie voor haar boekprogramma's. Bezoek voor meer informatie <a href="/Dutch/moneyBack-nl.asp">www.ITILstudy.com/ITIL-Training/moneyBack.asp</a>; U kunt ook de algemene voorwaarden voor de boekopleidingen van ITILstudy raadplegen op <a href="/Dutch/termsAndConditions.asp">www.ITILstudy.com/termsAndConditions.asp</a></p>

        </td>
      </tr>
      <%  If Session("CountryOrigin") <> "India"  Then  %>
       <tr><td align="center" colspan="3">
           <a href="https://www.facebook.com/ITILstudy/app_128953167177144" target="_blank">Houd contact voor meer van ITILstudy op Facebook.</a>.</td>
      </tr>
      <% End If %>

       <tr><td align="center" colspan="3"><font face="Arial" color = "green" size="2.5"><br />
            <b>
We kijken ernaar uit u als student van ITILstudy.com boekopleidingen te mogen verwelkomen!!!
</b></td>
      </tr>
      ...
      <tr>
        <td><br />
         ...
         Met vriendelijke groet,<br />
          ...
          E-mailadres: marketing@ITILstudy.com</span></td>
      </tr>
      <%
