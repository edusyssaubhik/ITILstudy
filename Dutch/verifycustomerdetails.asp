    ...
    <tr>
      <td height="235" align="left" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="8">
          <tr>
            ...
            <td width="73%" class="PageTitle">STUDENTEN INSCHRIJVEN</td>
          </tr>
          <tr>
		  <%
	   ...
	   %>
			...
			payer_email=payer_payment_email
                ...
                "<br />
                <br />
                <a href="/Mycourses.asp">Klik hier om uw cursussen te zien.</a><br />
                <br />
                <a href="/Dutch/ITIL-Online-Courses-nl.asp">Klik hier om in te schrijven in het begrijpen van ITIL-test</a>
                <%
						Else
								...
								MessageBody = "Dear "&first_name&" "&last_name&", <BR><BR>Welcome to ITILstudy.com.<BR><BR>You will have access for 2 days to "
								 ...
								 End If
								 MessageBody = MessageBody & " questions of the ITILstudy ITIL Foundation Exam Prep.<br><br>Please use these details to log on to ITILstudy.com (<a href=""http://www.ITILstudy.com/Dutch/memberlogin-nl.asp"">http://www.ITILstudy.com/Dutch/memberlogin-nl.asp</a>)<br><br>UserId: "&payer_email&"<br>Password: "&pass1&"<br><br>"
								
								' If (Session("CountryOrigin") = "India") Then
								' MessageBody = MessageBody & "We are pleased to inform you that we are also conducting our classroom programs in India. Our classroom courses are conducted by experienced faculty, who follow our effective study methodology, which has helped us to have one of the highest success rates in the industry. For more information on our classroom programs, please visit <a href=""http://www.itilstudy.com/Dutch/ITIL-Courses-nl.asp"">http://www.itilstudy.com/Dutch/ITIL-Courses-nl.asp</a>. The duration of our classroom programs is of 2 days with the ITIL Foundation exam conducted at the end of the second day of the training program.<br><br>"
           ...
           Set objRs1 = Server.CreateObject("ADODB.Recordset")		
               ...
               %>
                <%
                                ...
                                MessageBodydutch = "Hallo "&first_name&" "&last_name&", <BR><BR>Welcome to ITILstudy.com.<BR><BR>You will have access to: ITILstudy all sections of Service Design Online course which is valid for 90 days.<BR><BR> Please use these details to log into ITILstudy.com (<a href=http://www.ITILstudy.com/Dutch/memberlogin-nl.asp> member login</a>)<BR><BR> UserId: "&payer_email&"<BR>Password: "&pass&"<br><br>"&strPre&"<br><br>We hope you will enjoy your experience with ITILstudy.com. For queries, please email us at <a href=""mailto:adminsupport@ITILstudy.com"">adminsupport@ITILstudy.com</a>. We always look forward to your feedback and suggestions.<br><br>Note:- Kindly note that by enrolling in our course it is assumed that you have read through and accepted the Terms and Conditions related to the course as listed on the website, for details  <a href=""http://www.itilstudy.com/online-termsandcond.asp"" target=""_blank"">click here</a>.<BR><BR>Best Regards, <br><br>Customer Support,<BR><a href = ""http://www.ITILstudy.com/"" target=""_blank"">www.ITILstudy.com</a><BR>Email: <a href=""mailto: adminsupport@itilstudy.com"">adminsupport@itilstudy.com</a>"
                ...
                Dank u voor het inschrijven cursus met ons :    
               </br>
				</BR>
                Ga naar "mijn cursussen" pagina naar kunnen openen aan uw cursus <a href="/logoff.asp">door hier te klikken </A>. </BR>
                </BR>
                <B>BELANGRIJK (LET OP):</B> Een welkome e-mail met uw inloggegevens lid en Studie Procedure is verzonden naar uw e-mail-ID voor toekomstig gebruik;<BR>
                soms welkom e-mail zou kunnen gaan naar
                "Bulk E-mail" of "Junk E-mail" map, afhankelijk van uw E-mail Service Provider - zo wordt u verzocht om te kijken naar e-mails in deze mappen ook<BR>
                <!--<BR>
