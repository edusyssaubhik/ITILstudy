  ...
  <td height="235" align="left" valign="top" bgcolor="#FFFFFF">
   <table width="100%" border="0" cellspacing="0" cellpadding="8">
    <tr>
       <td width="2%">&nbsp;</td>
      <td width="25%" >&nbsp;</td>
	  <td width="73%" class="breadcrumb">Home &raquo; ITIL opleidingen  &raquo; Inschrijven</td>
    </tr>
    <tr>
    ...
    <% Else %>
	<h1 class="PageTitle">HET ITILSTUDY FOUNDATION PROGRAMMA
        ...
        <tr>
          <td><div style="margin-left:-0;"><span class="Required">
              <% = Session("message") %>
               ...
               <form action="/Dutch/enrollsuccess.asp" name="enrol" method="post" onsubmit="return validate_form(this)">
              <table border="0" cellpadding="5" cellspacing="0" width="100%">
                <tr>
                  <td ><span class="general-bodyBold">Voornaam:</span><span class="Required">*</span></td>
                  <td><input type="text" name="firstname" id="firstname" value="<% = firstName %>">&nbsp;<span class="Required"><%=ErrorFirstName %></span></td>
               </tr>
			   <tr>
                  <td><span class="general-bodyBold">Achternaam:</span><span class="Required">*</span></td>
                  <td><input type="text" name="lastname" id="lastname" value="<% = lastName %>" >&nbsp;<span class="Required"><%= ErrorLastName %></span></td>
                </tr>
                <tr>
                  <td colspan="4" ><span class="Note">*Deze naam wordt afgedrukt op alle certificaten</span></td>
                </tr>
                <tr>
				<td ><span class="general-bodyBold">Naam werkgever/bedrijf:</span></td>
                <td><input type="text" name="employer" id="employer" value="<% = NameOfEmployeer %>" ></td>
				</tr>
				<tr>
                 <td><span class="general-bodyBold">E-mailadres:</span><span class="Required">*</span></td>
                 <td><input type="text" name="email" id="email"  value="<% = Email %>" >&nbsp;<span class="Required"><%= ErrorEmail %></span></td>
                                </tr>
                <tr>
                      <td><span class="general-bodyBold">Telefoonnummer:</span><span class="Required">*</span></td>
                      <td><input type="text" name="phoneno" id="phoneno" value="<% = phoneno %>" >&nbsp;<span class="Required"><%= ErrorPhone %></span></td>
                     
                      </tr>
                      <tr>
                      <td colspan="4" ><span class="Note">*(Vorm: internationaal nummer-netnummer) bijv. 0031-13-7609365
                    </span></td>
                    </tr>
					 <tr>                 
                </tr>
                    ...
                    <tr>
                      <td><span class="general-bodyBold">Straat:</span>	<% If Session("CountryOrigin") <> "US" And Session("CountryOrigin") <> "Canada" Then %><span class="Required">*</span><% End If %></td>
                      <td><input type="text" name="street" id="street" value="<% = Street %>" >&nbsp;<span class="Required"><%= Errorstreet %></span></td>
                      </tr>
                       <tr>
                      <td><span class="general-bodyBold">Stad/dorp:*:</span><% If Session("CountryOrigin") <> "US" And Session("CountryOrigin") <> "Canada" Then %><span class="Required">*</span><% End If %></td>
                      <td><input type="text" name="city" id="city"  value="<% = city %>"  >&nbsp;<span class="Required"><%= Errorcity %></span></td>
					  </tr>
					  <tr>
                      <td><span class="general-bodyBold"> Provincie:</span><span class="Required">*</span></td>
                      <td><input type="text" name="state1" id="state1"  value="<% = statename %>" >&nbsp;<span class="Required"><%= Errorstate %></span></td>
                      </tr>
                       <tr>
                      <td><span class="general-bodyBold">Postcode:</span><% If Session("CountryOrigin") <> "US" And Session("CountryOrigin") <> "Canada" Then %><span class="Required">*</span><% End If %></td>            
                      <td><input type="text" name="postalCode" id="postalCode" value="<% = postalCode %>">&nbsp;<span class="Required"><%= ErrorpostalCode %></span></td>
                      </tr>
                        
					   <tr>
                       
				<td colspan="4" ><span class="Note">*Het bovenstaande adres en telefoonnummer zullen worden gebruikt om uw examen te registreren en certificaten zullen naar het door u gegeven adres worden verstuurd.</span></td>
                ...
                <% End If %>
                <tr>
                  <td><span class="general-bodyBold">Speciale eisen:</span></td>
                  <td colspan="3"><!--<textarea type="text" name="speReq" id="speReq" size="40" height="500" value="<%' = Session("speReq") %>"></textarea>-->
                    ...
                    <a href="/Dutch/specialReq.asp" style="vertical-align:top;" target="_blank">Meer te weten komen</a></td>
                </tr>
                <tr>
                  <td><span class="general-bodyBold">Inschrijven voor opleidingen:</span><span class="Required">*</span></td>
                ...
                <tr>
                  <td colspan="4"><span class="Note">*Alle prijzen op deze pagina zijn inclusief BTW</span></td>
                </tr>
       <!--         <tr>
                ...
                <tr><td colspan="4" style="text-align:center; width:280px;"><br /><input type="checkbox" name="check" id="check" />&nbsp;&nbsp;<span style=" position:relative; top:-2px;">Ik heb gelezen en ga akkoord met de <a href="/Dutch/termsAndConditions.asp" target="_blank">Algemene voorwaarden  </a></span><br/><span class="Required"><% = Errorcheck %></span></td></tr>
