...
Response.Write("<table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""0"" align=""center""><tr><td class=""TableRowOdd"" width=""100px""><span class=""HeaderLarge"">Locatie</span></td><td class=""TableRowOdd"" width=""100px""><span class=""HeaderLarge"">Data</span></td><td class=""TableRowOdd"" width=""150px""><span class=""HeaderLarge"">Tijden</span></td><td class=""TableRowOdd"" width=""140px""><span class=""HeaderLarge"">Prijs</span></td><td class=""TableRowOdd"" width=""100px"">&nbsp;</td></tr>")
	...
	For rowCounter = firstRow to lastRow			
		...
		End If 
			...
			End If
			'Date and Timing
			str = str & "</td><td class="&bgColor &">" & DAY(arrAllCourses(2,rowCounter)) & " " & MonthName(Month(arrAllCourses(2,rowCounter)),3) & " "  & YEAR(arrAllCourses(2,rowCounter)) & " tot  <br /> "& DAY(arrAllCourses(3,rowCounter)) & " " & MonthName(Month(arrAllCourses(3,rowCounter)),3) & " "  & YEAR(arrAllCourses(3,rowCounter))
			str = str & "</td>"
			'End If
		   ...
		   Else 
			...
			str = str & "<td class="& bgColor &">"
					...
					str= str &" + BTW <br />(Totaal "&Currency_Format_Front &" "& FormatNumber(arrAllCourses(15,rowCounter)) &" "& Currency_Format_Back &")<sup><font color=""red""><b>*</b></font></sup>" 
	...
	'PRICE WITH VAT, TAX, GST After EBD'
				...
				str= str &" + BTW <br />(Totaal "& Currency_Format_Front &" "& FormatNumber(arrAllCourses(12,rowCounter)) &" "& Currency_Format_Back &")"
		...
		str = str & "<td class="& bgColor &"><div align=""center""><form action=""/Dutch/enrollClass.asp"" method=""post""><input type=""hidden"" name=""SelCourseID"" value="&arrAllCourses(0,rowCounter)&" /><input type=""submit"" name=""TypeCourse"" value=""Live"" class=""ButtonSmall""/></form></div>"
		    Else 
			str = str & "<td class="& bgColor &"><div align=""center""><form action=""/Dutch/enrollClass.asp"" method=""post""><input type=""hidden"" name=""SelCourseID"" value="&arrAllCourses(0,rowCounter)&" /><input type=""submit"" name=""TypeCourse"" value=""Live"" class=""ButtonSmall""/></form></div></td>"
		  End IF
			   Else 
			 If Session("Country1") = "US" OR Session("Country1") = "Canada" Then	  
			str = str & "<td class="& bgColor &"><table colspan=""2""><tr><td><form action=""/Dutch/enrollClass.asp"" method=""post""><input type=""hidden"" name=""SelCourseID"" value="&arrAllCourses(0,rowCounter)&" /><input type=""hidden"" name=""coursetype"" value="&strCourse&"/><input type=""submit"" name=""TypeCourse"" value=""Live"" class=""ButtonSmall""/></form><form action=""/Dutch/enrollClass.asp"" method=""post""><input type=""hidden"" name=""SelCourseID"" value="&arrAllCourses(0,rowCounter)&" />"
			Else
			str = str & "<td class="& bgColor &"><table colspan=""2""><tr><td><form action=""/Dutch/enrollClass.asp"" method=""post""><input type=""hidden"" name=""SelCourseID"" value="&arrAllCourses(0,rowCounter)&" /><input type=""hidden"" name=""coursetype"" value="&strCourse&"/><input type=""submit"" name=""TypeCourse"" value=""Live"" class=""ButtonSmall""/></form><form action=""/Dutch/enrollClass.asp"" method=""post""><input type=""hidden"" name=""SelCourseID"" value="&arrAllCourses(0,rowCounter)&" />"
			End If
			If Session("CountryOrigin") = "United Kingdom" Then 
			...
			If Session("Country1") = "US" OR Session("Country1") = "Canada" Then				 
		str = str & "<td class="& bgColor &"><div align=""center""><form action=""/Dutch/enrollClass.asp"" method=""post""><input type=""hidden"" name=""SelCourseID"" value="&arrAllCourses(0,rowCounter)&" /><input type=""hidden"" name=""coursetype"" value="&strCourse&" /><input type=""submit"" name=""TypeCourse"" value=""Live"" class=""ButtonSmall""/></form></div>"
		Else
		str = str & "<td class="& bgColor &"><div align=""center""><form action=""/Dutch/enrollClass.asp"" method=""post""><input type=""hidden"" name=""SelCourseID"" value="&arrAllCourses(0,rowCounter)&" /><input type=""hidden"" name=""coursetype"" value="&strCourse&" /><input type=""submit"" name=""TypeCourse"" value=""Live"" class=""ButtonSmall""/></form></div></td>"
		End If
			Else
			str = str & "<td class="& bgColor &"><div align=""center""><form action=""/Dutch/enrollClass.asp"" method=""post""><input type=""hidden"" name=""SelCourseID"" value="&arrAllCourses(0,rowCounter)&" /><input type=""hidden"" name=""coursetype"" value="&strCourse&" />"
