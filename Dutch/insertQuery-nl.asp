  ...
  <table width="930" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="8">
      <tr>
        ...
        <td width="73%" class="PageTitle">HEEFT U EEN VRAAG / OPMERKING - SCHRIJF ONS</td>
      </tr>
      <tr>
...
If sIPAddress="" Then sIPAddress = Request.ServerVariables("REMOTE_ADDR")
	...
	strText = "Beste "&CustomerName&",<BR><BR>Hartelijk dank voor uw vraag aan ITILstudy.com. We zullen uw vraag zo spoedig mogelijk beantwoorden. <BR><BR>We hopen dat u ITILstudy.com als prettig ervaart. Mocht u verdere vragen hebben, dan kunt u altijd een e-mail sturen naar adminsupport@ITILstudy.com."		                
	End If  
