...
rsQues.Open "SELECT Question_RCVDB.QuestionDesc, Question_RCVDB.CorrectChoice, Question_RCVDB.Justification, Question_RCVDB.ExhibitURL ,Choice_RCVDB.ChoiceNumber, Choice_RCVDB.ChoiceValue from Question_RCVDB, Choice_RCVDB WHERE Question_RCVDB.KNo='"&KNo&"' and Choice_RCVDB.KNo='"&KNo&"' and Question_RCVDB.QuestionNo='"&QuesAsked&"' and Question_RCVDB.QuestionNo=Choice_RCVDB.QuestionNo ORDER by Choice_RCVDB.ChoiceNumber"
    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td colspan="2" height="84" class="TableRowOdd"><div align="left">
            ...
            <a href="/ITIL/chapterTestsIndex.asp" onclick="return ExitAlert(this.href);"><input type="button" class="ButtonTest" value="Exit" /></a>
          </td>
