...
<table width="40%" border="0" cellpadding="0" cellspacing="0">
      ...
      <form method="post" action="/ITIL-RCV/pduquesget1.asp">
    ...
    <FORM METHOD="POST" ACTION="/ITIL-RCV/pduquesget2.asp">
    ...
    <%else
		...
		rsQues.Open "SELECT Question_RCVDB.QuestionDesc, Question_RCVDB.ExhibitURL ,Choice_RCVDB.ChoiceNumber, Choice_RCVDB.ChoiceValue from Question_RCVDB, Choice_RCVDB WHERE Question_RCVDB.KNo='"&KNo&"' and Choice_RCVDB.KNo='"&KNo&"' and Question_RCVDB.QuestionNo='"&sArray(nCurNo,0,0)&"' and Question_RCVDB.QuestionNo=Choice_RCVDB.QuestionNo Order by Choice_RCVDB.ChoiceNumber"
		...
		ChoiceValue4=rsQues("ChoiceValue")%>
            ...
            <tr>
              <td height="84" colspan="2" class="TableRowOdd"><div align="left"><span class="PopupCopy">
                  ...
                  <a href="/ITIL-RCV/pdusindex.asp" onclick="return ExitAlert(this.href);"><input type="button" class="ButtonTest" value="Exit" /></a>
                  </span></td>
            </tr>
          </table>
    </form>
...
%>
    There are no questions
     <a href="/ITIL-RCV/pdusindex.asp"><input type="button" class="ButtonTest" value="Exit" /></a>
    <%End If
%>
    <%Session("PDUArray")=sArray
%>
