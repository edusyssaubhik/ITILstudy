  ...
  <table width="930" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <td height="235" align="left" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="8">
        <tr>
          ...
          <td width="73%" class="PageTitle">Chapter Tests <a href="/ITIL-RCV/help.asp#chapter-test" style="float:right; margin-right:20px;"><img src="/images/buttons/Help.png" height="20px" style="border-color:#FFFFFF" onmouseover="this.src='/images/buttons/help_h.png'" onmouseout="this.src='/images/buttons/Help.png'"></a></td>
        </tr>
        <tr>
...
rsQues.Open "select KNo, Areatitle from KArea_RCV"%>
            <div>
              <table width="95%" border="0" cellspacing="3" cellpadding="3" align="left" class="general-body">
                <form method="post" action="/ITIL-RCV/getScenario.asp" >
                  <%Dim KNumber, count
...
%>
                  ...
                  <tr>
                    <td  >&nbsp;</td>
                    <td colspan="4" ><input type="submit" class="ButtonGeneral" value="Enter Selection">
                    </td>
                  </tr>
                  </tr>
