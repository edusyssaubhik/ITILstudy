...
var r=confirm("Are you sure you want quit the chapter test?");
	...
	if (r==true) {
		top.location.href='/Foundation/chapterTestsIndex_V2.asp';
	}
	else {
		return false;
	}
...
rsQues.Open "SELECT Question_ITILFondDB_Dec2011.QuestionDesc, Question_ITILFondDB_Dec2011.CorrectChoice, Question_ITILFondDB_Dec2011.Justification, Question_ITILFondDB_Dec2011.ExhibitURL ,Choice_ITILFondDB_Dec2011.ChoiceNumber, Choice_ITILFondDB_Dec2011.ChoiceValue from Question_ITILFondDB_Dec2011, Choice_ITILFondDB_Dec2011 WHERE Question_ITILFondDB_Dec2011.KNo='"&KNo&"' and Choice_ITILFondDB_Dec2011.KNo='"&KNo&"' and Question_ITILFondDB_Dec2011.QuestionNo='"&QuesAsked&"' and Question_ITILFondDB_Dec2011.QuestionNo=Choice_ITILFondDB_Dec2011.QuestionNo ORDER by Choice_ITILFondDB_Dec2011.ChoiceNumber"
'response.Write("SELECT Question_ITILFondDB_Dec2011.QuestionDesc, Question_ITILFondDB_Dec2011.CorrectChoice, Question_ITILFondDB_Dec2011.Justification, Question_ITILFondDB_Dec2011.ExhibitURL ,Choice_ITILFondDB_Dec2011.ChoiceNumber, Choice_ITILFondDB_Dec2011.ChoiceValue from Question_ITILFondDB_Dec2011, Choice_ITILFondDB_Dec2011 WHERE Question_ITILFondDB_Dec2011.KNo='"&KNo&"' and Choice_ITILFondDB_Dec2011.KNo='"&KNo&"' and Question_ITILFondDB_Dec2011.QuestionNo='"&QuesAsked&"' and Question_ITILFondDB_Dec2011.QuestionNo=Choice_ITILFondDB_Dec2011.QuestionNo ORDER by Choice_ITILFondDB_Dec2011.ChoiceNumber")
%>
<% If Not rsQues.BOF Then%>
<form method="post" action="ansget_V2.asp">
  <%
    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td colspan="2" height="84" class="TableRowOdd"><div align="left">
            ...
            <a href="/ITIL/chapterTestsIndex_V2.asp" onclick="return ExitAlert(this.href);"><input type="button" class="ButtonTest" value="Exit" /></a>
          </td>
...
<BR>
Please <a href="http://www.itilstudy.com/index.asp">Go to home Page</A> or <a href="./chaptertestsindex_V2.asp">Work on questions again</A>
<%
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="TableTest">
  ...
  <tr>
    <td height="84" class="TableRowOdd"><div align="left">
      <span class="PopupCopy">
      <form method="post" action="chaptertestsindex_V2.asp">
