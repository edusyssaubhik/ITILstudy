            ...
            <td width="73%" rowspan="4" background="/images/back/left_line.jpg" class="general-body">
                ...
                <div>
                  <%
					...
					rsQues1.Open "SELECT CorrectChoice,QuestionNo FROM Question_ITILDB WHERE Question_ITILDB.KNo='"&KNo&"'"
                ...
                <div>
                  ...
                  <form method="post" action="/ITIL/pduquesget1.asp" target="_blank">
