...
<div>
  <table width="930" border="0" align="center" cellpadding="0" cellspacing="0">
	...
	strQuery = "select payer_email, first_name, last_name, date_entered ,date_valid, address_country,address_city from PaypalDB where rollno= '"& rollNo  &"' "
	...
	'response.Write(strQuery)
       Do Until objRs1.EOF
				...
				date_entered =  objRs1("date_entered")
				date_valid       =  objRs1("date_valid")
		   objRs1.Movenext
		   Loop
		   objRs1.Close
	 ...
	 %>
      ...
      <form name="complaint" action="insertFeedback.asp" method="post" onSubmit="return validate_form(this)">
        ...
        <input type="hidden" name="LastName" value="<% = LastName %>" />
         <input type="hidden" name="StartDate" value="<% = date_entered %>" />
		  <input type="hidden" name="EndDate" value="<% = date_valid %>" />
