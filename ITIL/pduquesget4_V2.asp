...
rsQues.Open "SELECT PDUs, AreaTitle, PDUs from KArea_ITIL WHERE KNo='"&KNo&"'"
...
If ((Session("State") = "verified1" OR Session("State") = "verified2" OR Session("State") = "verified3" OR Session("State") = "verified5" OR Session("State") = "verified6" OR Session("State") = "verified7" OR Session("State") = "verified13") AND int(Session("KnoPassed"))<kno_passed) Then
...
Response.Write "You successfully completed all the chapters in foundation course. <BR><BR><font color=""red""><B>Congratulations for completing all the chapters.</B></font>"
