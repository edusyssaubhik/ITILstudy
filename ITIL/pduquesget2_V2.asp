...
<% if (quesCorrect>=6) then%>
	...
	<FORM METHOD="POST" ACTION="/ITIL/pduquesget4_V2.asp">
...
<% else%>
	...
	To pass in the evaluation test on this chapter, you should correctly answer 6 out of 10 questions (i.e. 60%).</font><BR><BR><B>Please review the answers and <a href="./pdusindex_V2.asp">Take the Evaluation Test again</A></B>.
<% end if%>	
</p>
<BR><BR>	
</body>
