...
var r=confirm("Are you sure you want quit the evaluation test?");
	...
	if (r==true) {
		top.location.href='/ITIL/pdusindex.asp';
	}
	else {
		return false;
	}
...
<table width="40%" border="0" cellpadding="0" cellspacing="0">
      ...
      <form method="post" action="/ITIL/pduquesget1.asp">
    ...
    <FORM METHOD="POST" ACTION="/ITIL/pduquesget2.asp">
		...
		ChoiceValue4=rsQues("ChoiceValue")%>
            ...
            <tr>
              <td height="84" colspan="2" class="TableRowOdd"><div align="left"><span class="PopupCopy">
                  ...
                  <a href="/ITIL/pdusindex.asp" onclick="return ExitAlert(this.href);"><input type="button" class="ButtonTest" value="Exit" /></a>
                  </span></td>
            </tr>
          </table>
    </form>
...
%>
    There are no questions
     <a href="/ITIL/pdusindex.asp"><input type="button" class="ButtonTest" value="Exit" /></a>
    <%End If
%>
    <%Session("PDUArray")=sArray
%>
