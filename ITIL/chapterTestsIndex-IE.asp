...
<script language="JavaScript" type="text/javascript" src="/js/getKno-IE.js"></script>
...
rsQues.Open "select KNo, Areatitle from KArea_ITIL"%>
                <div>
                  <table width="95%" border="0" cellspacing="3" cellpadding="3" align="left" class="general-body">
                   <form method="post" action="/ITIL/quessget-IE.asp" target="_blank">
                      <%Dim KNumber, count
...
%>
                   ...
                   'response.Write(questionNo)
                      ...
                      <tr id= "Chapter" >
						...
						<select name=""  id="NoofQues" class="TeXtFielddropdown" style="width:45px;" onChange="findNoOfQues(this.value);">
