...
var r=confirm("Are you sure you want quit the evaluation test?");
	...
	if (r==true) {
		top.location.href='/ITIL/pdusindex_V2.asp';
	}
	else {
		return false;
	}
...
<table width="40%" border="0" cellpadding="0" cellspacing="0">
      ...
      <form method="post" action="/ITIL/pduquesget1_V2.asp">
    ...
    <FORM METHOD="POST" ACTION="/ITIL/pduquesget2_V2.asp">
    ...
    <%else
		...
		rsQues.Open "SELECT Question_ITILFondDB_Dec2011.QuestionDesc, Question_ITILFondDB_Dec2011.ExhibitURL ,Choice_ITILFondDB_Dec2011.ChoiceNumber, Choice_ITILFondDB_Dec2011.ChoiceValue from Question_ITILFondDB_Dec2011, Choice_ITILFondDB_Dec2011 WHERE Question_ITILFondDB_Dec2011.KNo='"&KNo&"' and Choice_ITILFondDB_Dec2011.KNo='"&KNo&"' and Question_ITILFondDB_Dec2011.QuestionNo='"&sArray(nCurNo,0,0)&"' and Question_ITILFondDB_Dec2011.QuestionNo=Choice_ITILFondDB_Dec2011.QuestionNo Order by Choice_ITILFondDB_Dec2011.ChoiceNumber"
		...
		ChoiceValue4=rsQues("ChoiceValue")%>
            ...
            <tr>
              <td height="84" colspan="2" class="TableRowOdd"><div align="left"><span class="PopupCopy">
                  ...
                  <a href="/ITIL/pdusindex_V2.asp" onclick="return ExitAlert(this.href);"><input type="button" class="ButtonTest" value="Exit" /></a>
                  </span></td>
            </tr>
          </table>
    </form>
...
%>
    There are no questions
     <a href="/ITIL/pdusindex_V2.asp"><input type="button" class="ButtonTest" value="Exit" /></a>
    <%End If
%>
    <%Session("PDUArray")=sArray
%>
