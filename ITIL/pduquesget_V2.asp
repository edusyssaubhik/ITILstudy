            ...
            <td width="73%" rowspan="4" background="/images/back/left_line.jpg" class="general-body">
                ...
                <div>
                  <%
					...
					rsQues1.Open "SELECT CorrectChoice,QuestionNo FROM Question_ITILFondDB_Dec2011 WHERE Question_ITILFondDB_Dec2011.KNo='"&KNo&"'"
                ...
                <div>
                  ...
                  <form method="post" action="/ITIL/pduquesget1_V2.asp" target="_blank">
