...
Courses, please have a look at the screenshots and related explanation given below:</p>
			 ...
			 <span class="SubHeader"><strong>Login Page</strong></span>
                  ...
                  <p><a href="/images/img_ITILhelp/Welcome.png" target="_blank"><img src="/images/img_ITILhelp/Welcome-s.png" width="288px" height="148px" border="0" style="border:1px #CCCCCC solid;"/></a></p>
				    <ul>
                  ...
                  <p><a href="/images/img_ITILhelp/overview.png" target="_blank"><img src="/images/img_ITILhelp/overview-s.png" width="288px" height="148px" border="0" style="border:1px #CCCCCC solid;"/></a></p>
				  ...
				  <li><span class="SubHeader">Study Methodology:</span> Gives a brief on the methodology to be followed while taking a ITILstudy online course.</li>
                    ...
                    <li><span class="SubHeader">Mock Test:</span> Take the mock test to further strengthen your preparation and improve on your shortcomings before you attempt the exam. This test will be accessible only after all the chapters are  completed
