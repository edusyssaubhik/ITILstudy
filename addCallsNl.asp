...
strAllcoatedCity = "SELECT fac_emailid1 , fac_emailid2 , fac_emailid3 , fac_emailid4 , fac_emailid5 , fac_thi_emailID1, fac_thi_emailID2, fac_thi_emailID3, fac_thi_emailID4, fac_thi_emailID5 FROM  itil_states WHERE states = '"& rqState &"' and (country = 'Netherlands')"
...
%>
If you want add one more caller detials please <a href="/callsNl.asp">click here</a>
