    ...
    <% else %>
      <% 
		...
		<td width="73%" background="/images/back/left_line.jpg" class="general-body" rowspan="4"><div style="margin-top:-12px;">
				...
				<span class="Error">The email address is not registered with us so, enter email address you registered with.</span>
                <br>
				...
				<b>Email ID:</b><input type="text" style="margin-left:10px;" name="UserID">
				<input type="submit" value="submit" name="submit"><table width="95%" cellspacing="0" cellpadding="3" border="0" class="general-body">               
