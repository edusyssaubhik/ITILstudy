  ...
  <table width="930" border="0" align="center" cellpadding="0" cellspacing="0">
	...
	%>
              ...
              <table border="0" align="left" width="95%" cellspacing="0" class="TableGeneral">
                <tr>
				 ...
				 <%
							...
							If (Session("CountryOrigin") = "United Kingdom" OR Session("CountryOrigin") = "India" OR Session("CountryOrigin") = "Germany" OR Session("CountryOrigin") = "Australia" OR Session("CountryOrigin") = "Switzerland") Then
                ...
                <tr>
                  ...
                  <% 'If (Session("CountryOrigin") = "United Kingdom" OR Session("CountryOrigin") = "Germany") Then %>
                  <% If (Session("CountryOrigin") = "United Kingdom" OR Session("CountryOrigin") = "Germany" OR Session("CountryOrigin") = "India" OR Session("CountryOrigin") = "Australia" OR Session("CountryOrigin") = "Switzerland") Then %>
                  ...
                  <tr>
                    <td class="TableRowEven"><span class="TableCopyName">VAT @
                      ...
                      10%
                         <% ElseIf (Session("CountryOrigin") = "Switzerland") Then %>
                      19%
      ...
      <table border="0">
       ...
       <% ElseIf Session("CountryOrigin") = "Germany" OR Session("CountryOrigin") = "Switzerland"  Then %>
            <tr>
