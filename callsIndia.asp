...
'======================================================='
'Written By : savita'
'Created Date : 06/03/2011'
'Last Updated : 06/03/2011'
'Description :'
'This page is ITILstudy adding India calls to the database'
'US BackOffice'
'======================================================='

'Declare the local variables'
Dim strIndia, objRs, objRs1
...
<table border="1" cellpadding="5" cellspacing="0" align="center" width="45%">
 ...
 <tr>
  <td>
  <form name="addCallsIndia" action="addCallsIndia.asp" method="post" onsubmit="return Form_Validator(this)">
...
<tr>
	 ...
	 <td>  <select name="state">
	  ...
	  <%
	  'Retrive the states'
		strIndia = "SELECT distinct state FROM ITIL_city WHERE country = 'India' ORDER BY state"

		objRs.Open strIndia,ConnObj
