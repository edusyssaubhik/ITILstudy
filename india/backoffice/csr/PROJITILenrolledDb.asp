...
ElseIf rqType = "enrollStatus" And POExpectedDate1 = "" Then
	...
	Conn.Execute "UPDATE PROJITIL_enrolledusers SET us_status = '" & rqEnrollStatus & "', us_status_addedby = '"& Session("UserId") &"' WHERE id = '" & rqEnrollUserId &"'"
...
ElseIf  rqType = "enrollStatus" And EnrollStatus = "P.O Received" AND POExpectedDate1 <> "" Then
	...
	Conn.Execute "UPDATE PROJITIL_enrolledusers SET us_status = '" & rqEnrollStatus & "', po_expected = '" & rqPOExpected & "', us_status_addedby = '"& Session("UserId") &"' WHERE id = '" & rqEnrollUserId &"'"
