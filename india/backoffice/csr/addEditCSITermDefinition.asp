...
If rqType = "Add" Then
 ...
 strQuery = "INSERT INTO CSIterm_definition (term,definition,addedby,addedon)"
 ...
 Response.Redirect("CSIterms_definition.asp")
...
If rqType = "Update" Then
 ...
 strQuery = "UPDATE CSIterm_definition SET"
...
Else
 ...
 strQuery1 = "DELETE  FROM CSIterm_definition WHERE id = '" & rqDelete & "'"
