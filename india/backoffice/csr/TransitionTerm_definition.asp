...
If rqTerm <> "" Then
 ...
 strQuery = "SELECT * FROM Transitionterm_definition Where term like '%"&rqTerm&"%' "
 
 Else

 strQuery = "SELECT * FROM Transitionterm_definition"
...
rqEdit = Request.Querystring("editTermId")
 ...
 strQuery1  = "SELECT * FROM Transitionterm_definition WHERE id = '" & rqEdit & "'"
...
<title>Service Transition Terms Definition</title>
 ...
 <tr>
   ...
   <td height="25">
    <table width="100%" >
          <tr>
            <td width="10%">
   <a href="TransitionTerm_definition.asp?type=add">Add Service Transition Terms definition</a></td>
    <% If rqType <> "add" And rqType <> "Edit"  Then %>
 		<form action="TransitionTerm_definition.asp" method="post">
   ...
   <tr>
	  <td>
	   <form action="addEditTransitionTerm_definition.asp" method="post" onSubmit="return validate_form(this)">
	   <table border="0" align="center" cellpadding="5" cellspacing="5" class="dbborder" >
	    <tr>
	      <td colspan="2" align="center" bgcolor="#A7DBFB"><font size="3"><b>Add Service Transition Terms Definition</b></font></td>
	    </tr>
	    <tr>
	      <td width="30%">Term:</td>
  ...
  <% If rqType = "Edit"  Then %>
      <tr>
         <td>
	       <form action="addEditTransitionTerm_definition.asp" method="post" onSubmit="return validate_form1(this)">
	       <table border="0" align="center" cellpadding="5" cellspacing="5" class="dbborder">
	        <tr>
	         <td colspan="2" align="center" bgcolor="#A7DBFB"><font size="3"><b>Edit Service Transition Terms Definition</b></font></td>
	        </tr>
	        <% do until Rs1.EOF %>
    ...
    <tr height="500">
     ...
     <% editTermId = arrAllQueries(0,rowcounter) %>
       ...
       <td align="center"><a href="TransitionTerm_definition.asp?type=Edit&editTermId=<% = editTermId %>">Edit</a></td>
       <td align="center"><a href="addEditTransitionTerm_definition.asp?deleteTermId=<% = editTermId %>" onclick="return DeleteAlert(this.href);">Delete</a></td>
    </tr>
		<% Next %>
            <tr id="htMap">
              <td colspan="8"><!--#include file="pagination.asp"-->
               <% 
			    ps = getPaginationString(page, (numRows + 1), 10, 2, "TransitionTerm_definition.asp?type=editOrDelete")
				  Response.Write(ps)
	           %>
