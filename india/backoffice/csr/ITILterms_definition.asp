...
If rqTerm <> "" Then
 ...
 strQuery = "SELECT * FROM ITILterm_definition Where term like '%"&rqTerm&"%' "
 
 Else

 strQuery = "SELECT * FROM ITILterm_definition"
...
rqEdit = Request.Querystring("editTermId")
 ...
 strQuery1  = "SELECT * FROM ITILterm_definition WHERE id = '" & rqEdit & "'"
 ...
 <tr>
   ...
   <td height="25">
    <table width="100%" >
          <tr>
            <td width="10%">
   <a href="ITILterms_Definition.asp?type=add">Add Foundation Terms definition</a></td>
    <% If rqType <> "add" And rqType <> "Edit"  Then %>
 		<form action="ITILterms_Definition.asp" method="post">
   ...
   <tr>
	  <td>
	   <form action="addEditITILTermDefinition.asp" method="post" onSubmit="return validate_form(this)">
	   <table border="0" align="center" cellpadding="5" cellspacing="5" class="dbborder" >
	    <tr>
	      <td colspan="2" align="center" bgcolor="#A7DBFB"><font size="3"><b>Add Foundation Terms Definition</b></font></td>
	    </tr>
	    <tr>
	      <td width="30%">Term:</td>
  ...
  <% If rqType = "Edit"  Then %>
      <tr>
         <td>
	       <form action="addEditITILTermDefinition.asp" method="post" onSubmit="return validate_form1(this)">
	       <table border="0" align="center" cellpadding="5" cellspacing="5" class="dbborder">
	        <tr>
	         <td colspan="2" align="center" bgcolor="#A7DBFB"><font size="3"><b>Edit Foundation Terms Definition</b></font></td>
	        </tr>
	        <% do until Rs1.EOF %>
    ...
    <tr height="500">
     ...
     <% editTermId = arrAllQueries(0,rowcounter) %>
       ...
       <td align="center"><a href="ITILterms_Definition.asp?type=Edit&editTermId=<% = editTermId %>">Edit</a></td>
       <td align="center"><a href="addEditITILTermDefinition.asp?deleteTermId=<% = editTermId %>" onclick="return DeleteAlert(this.href);">Delete</a></td>
    </tr>
		<% Next %>
            <tr id="htMap">
              <td colspan="8"><!--#include file="pagination.asp"-->
               <% 
			    ps = getPaginationString(page, (numRows + 1), 10, 2, "ITILterms_Definition.asp?type=editOrDelete")
				  Response.Write(ps)
	           %>
