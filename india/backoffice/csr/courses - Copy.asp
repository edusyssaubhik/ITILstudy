...
'If course is cancelled ,Hide the paymentreceived mail Link
'Start
    Set rsCancelled = Server.CreateObject("Adodb.Recordset")
    qCancelled = "SELECT * FROM ITIL_course WHERE courseid = '"& rqCourseId &"'"
    rsCancelled.Open qCancelled,Conn
    If Not rsCancelled.EOF Then
        CourseStatus_Cancel = Trim(rsCancelled("Status"))
    End If
    rsCancelled.close
'End
                	...
                	<td>
                     ...
                     <tr>
                      <td><% if  (arrAllQueries(11,enrollrowcounter)  = "Yes") then%>
                       ...
                       %>
                         <%  If CourseStatus_Cancel <> "Cancelled" Then
