...
If rqType = "Add" Then
 ...
 strQuery = "INSERT INTO DesignTerm_definition (term,definition,addedby,addedon)"
 ...
 Response.Redirect("DesignTerm_definition.asp")
...
If rqType = "Update" Then
 ...
 strQuery = "UPDATE DesignTerm_definition SET"
...
Else
 ...
 strQuery1 = "DELETE  FROM DesignTerm_definition WHERE id = '" & rqDelete & "'"
