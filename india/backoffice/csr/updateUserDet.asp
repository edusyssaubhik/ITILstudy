...
'------------------------------------------------------'
 ...
 Dim FirstName, LastName, Employeer, PhoneNo, Cand_No,rqCand_No
...
End Function 
 ...
 rqCourseId        =   Request.QueryString("courseId")
  ...
  strQuery = "Select firstname, lastname, nameofemployeer, email, phoneno, amount,Cand_No from ITIL_enrolledusers  WHERE id = '"&rqEnrollUserId&"'"
...
<tr>
    <td width="30%"><b>Candidate No:</b></td>
    <td><input type="text" id="Cand_No" name="Cand_No" value="<% = Cand_No %>" /></td>
  </tr>
<tr>
...
If rqType = "submit" Then
 ...
 strEdit = "UPDATE ITIL_enrolledusers SET"
 ...
 strEdit = strEdit & " amount = '" & rqAmount & "'," 
  strEdit = strEdit & " Cand_No = '" & rqCand_No & "'" 
