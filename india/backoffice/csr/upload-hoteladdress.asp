...
<title>Uploading ITILstudy Venue Details</title>
...
If rqCity <> "" Then
	...
	strHotelAdd = "UPDATE itil_course SET hotelname = '"& rqHName &"', hoteladdress = '"& rqHAddress &"', hotelphonenumber = '"& rqHPhoneNo &"' WHERE city = '"& rqCity &"' AND (country = '"& Session("country") &"') AND (startdate BETWEEN '"&rqFromDate&"' AND '"&rqToDate&"') AND hotelname = ''"
...
strCity = "SELECT city FROM itil_city WHERE country = '"& Session("country") &"' order by city"
...
<table border="1" cellspacing="0" cellpadding="5">
	<tr>
     <td colspan="2" align="center">Uploading ITILstudy Venue Details</td>
    </tr>
    <tr>
    	<td>City:</td>
        <td>
