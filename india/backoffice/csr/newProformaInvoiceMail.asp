...
If (Session("Country") = "United Kingdom" OR Session("Country") = "India" OR Session("Country") = "Australia" ) Then
	...
	strCountryDetails = "SELECT * FROM ITIL_countrydetails WHERE country = '" & Session("Country") & "' AND id = (SELECT MAX(id) FROM ITIL_countrydetails WHERE country = '"& Session("Country") &"')"
	...
	strQuery1 = "Update ITIL_enrolledusers Set "
	If (Session("Country") = "United Kingdom" OR Session("Country") = "India" OR Session("Country") = "Australia" ) Then
 ...
 subject="PROFORMA INVOICE"
	  ...
	  body = "<table width=""100%"" bgcolor=""#CCCCCC"" style=""margin:0px;0px;0px;0px;""><tr height=""45px""><td> </td></tr><tr><td><table width=""600px"" border=""0"" align=""center"" cellpadding=""2"" cellspacing=""12"" bgcolor=""#FFFFFF""><tr><td width=""595px"" bgcolor=""#FFFFFF""><span><img src=""http://www.ITILstudy.com/images/banners/Email-Header.jpg"" alt=""ITILstudy"" width=""600px"" height=""103"" /></span></td></tr>"
	  ...
	  body = body & "<tr><td align=""left""><br><font face=""Arial"" size=""2"">Thank you for enrolling in ITILstudy.com classroom training.</font></td></tr>"
	  ...
	  body = body & "<tr><td><font face=""Arial"" size=""2""><b>ITIL Classroom Training"
...
'	  End If
	  ...
	  body = body & "<a href=""http://www.ITILstudy.com/payment.asp?enrollUserID="& PICode &"&Country="& Session("country") &"""><font face=""Arial"" size=""3"" color=""#0359b4""><b>Buy Now</b></font></a></li><br>"
	  body = body & "<li><font face=""Arial"" size=""2""><b>PayPal: </b></font>"
	  body = body & "<a href=""http://www.ITILstudy.com/payment.asp?enrollUserID="& PICode &"&Country="& Session("country") &"""><font face=""Arial"" size=""3"" color=""#0359b4""><b>Buy Now</b></font></a></li></ul>"
	  End If
	  If Session("country") = "India" Then
 ...
 If (Session("country") = "India") Then 
  ...
  End If
	body = body & "<tr><td align=""left"" colspan=""2""><br><font face=""Arial"" size=""2""><i>We have reserved a place for you in this course. However, the payment should be received by us "
	  ...
	  body = body & " - <i>otherwise, your registration for this program will be cancelled.</i> </font></td></tr>"
	  body = body & "<tr><td align=""left"" colspan=""2""><font face=""Arial"" size=""2""><br>Please Note: You will be provided access to the free 100% Online Preparatory Course for ITILstudy.com Classroom Course only after we receive your payment: this is a simple online course which can be completed with a few hours of study and will provide you with the 18 PMI approved contact hours required to apply for ITIL Exam.<br><br>"
	  If (Session("country") = "India") Then 
	  body = body & "For ITILstudy classroom training terms and conditions, please visit <a href=""http://www.itilstudy.com/termsAndConditions.asp"" target=""_blank"">www.ITILstudy.com/termsAndConditions.asp</a>."
	 Else
	 
	  body = body & "ITILstudy offers Moneyback Guarantee on its classroom programs. For details, visit <a href=""http://itilstudy.com/ITIL-Training/moneyBack.asp"" target=""_blank"">http://itilstudy.com/ITIL-Training/moneyBack.asp</a>. Also, please refer to ITILstudy classroom training terms and conditions: <a href=""http://www.itilstudy.com/termsAndConditions.asp"" target=""_blank"">www.ITILstudy.com/termsAndConditions.asp</a>."
	  End If
	  body = body & "</font></td></tr>"
	  body = body & "<tr><td align=""center"" colspan=""3""><br><font face=""Arial"" color = ""green"" size=""3"">We look forward to having you as a student with ITILstudy.com Classroom Training!!!</font></td></tr>"
	  ...
	  body = body & "<tr><td align=""left""><font face=""Arial"" size=2><a href=""http://www.ITILstudy.com"" target=""_blank"">www.ITILstudy.com</a></font></td></tr>"
	  'body = body & "<tr><td align=""left""><font face=""Arial"" size=2>(PMI Approved Global Registered Education Provider)</font></td></tr>"
	  body = body & "<tr><td align=""left""><font face=""Arial"" size=2>Email: marketing@itilstudy.com</font></td></tr></table></td></tr><tr height=""30px""><td align=""center""><font face=""Arial"" size=2 style=""color:#808080"">"
 If (Session("country") = "India" ) Then
...
'Retrive The enrolluserid from this page'  
   ...
   body    = Request.form("QueryReply")
	...
	objCDOMail.BCC = "t_satpathy@yahoo.com,edusysayan@gmail.com,edusysamandeep@gmail.com"
