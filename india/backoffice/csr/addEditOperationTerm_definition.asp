...
If rqType = "Add" Then
 ...
 strQuery = "INSERT INTO OperationTerm_definition (term,definition,addedby,addedon)"
 ...
 Response.Redirect("OperationTerm_definition.asp")
...
If rqType = "Update" Then
 ...
 strQuery = "UPDATE OperationTerm_definition SET"
...
Else
 ...
 strQuery1 = "DELETE  FROM OperationTerm_definition WHERE id = '" & rqDelete & "'"
