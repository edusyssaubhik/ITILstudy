 //globals
 var first = "instructorCity"; //id of first SELECT
 var second = "instructorLocation"; //id of second SELECT
...
//
 ...
 if(selected!= 0) { //if they choose something other than the first select-->"Select topic first"
    sendRequest('getLocations.asp?instructorCity='+el.options[selected].value);
    ob2.disabled=0;
