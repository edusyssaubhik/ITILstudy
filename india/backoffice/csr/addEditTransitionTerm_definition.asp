...
If rqType = "Add" Then
 ...
 strQuery = "INSERT INTO TransitionTerm_definition (term,definition,addedby,addedon)"
 ...
 Response.Redirect("TransitionTerm_definition.asp")
...
If rqType = "Update" Then
 ...
 strQuery = "UPDATE TransitionTerm_definition SET"
...
Else
 ...
 strQuery1 = "DELETE  FROM TransitionTerm_definition WHERE id = '" & rqDelete & "'"
