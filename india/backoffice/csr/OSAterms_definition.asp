...
If rqTerm <> "" Then
 ...
 strQuery = "SELECT * FROM OSAterm_definition Where term like '%"&rqTerm&"%' "
 
 Else

 strQuery = "SELECT * FROM OSAterm_definition"
 End If
...
rqEdit = Request.Querystring("editTermId")
 ...
 strQuery1  = "SELECT * FROM OSAterm_definition WHERE id = '" & rqEdit & "'"
...
<title>OSA Terms Definition</title>
...
<table border="1" width="1000" height="500" cellpadding="2" cellspacing="0" class="dbborder" >
 ...
 <tr>
   <td width="100px" valign="top" rowspan="22">
    ...
    <table width="100%" >
          <tr>
            <td width="10%"><a href="OSAterms_Definition.asp?type=add">Add OSA Terms definition</a></td> 
			<% If rqType <> "add" And rqType <> "Edit"  Then %>
 		<form action="OSAterms_Definition.asp" method="post">
   ...
   <tr>
	  <td>
	   <form action="addEditOSATermDefinition.asp" method="post" onSubmit="return validate_form(this)">
	   <table border="0" align="center" cellpadding="5" cellspacing="5" class="dbborder" >
	    <tr>
	      <td colspan="2" align="center" bgcolor="#A7DBFB"><font size="3"><b>Add OSA Terms Definition</b></font></td>
	    </tr>
	    <tr>
	      <td width="30%">Term:</td>
  ...
  <% If rqType = "Edit"  Then %>
      <tr>
         <td>
	       <form action="addEditOSATermDefinition.asp" method="post" onSubmit="return validate_form1(this)">
	       <table border="0" align="center" cellpadding="5" cellspacing="5" class="dbborder">
	        <tr>
	         <td colspan="2" align="center" bgcolor="#A7DBFB"><font size="3"><b>Edit OSA Terms Definition</b></font></td>
	        </tr>
	        <% do until Rs1.EOF %>
    ...
    <tr height="500">
     ...
     <% editTermId = arrAllQueries(0,rowcounter) %>
       ...
       <td align="center"><a href="OSAterms_Definition.asp?type=Edit&editTermId=<% = editTermId %>">Edit</a></td>
       <td align="center"><a href="addEditOSATermDefinition.asp?deleteTermId=<% = editTermId %>" onclick="return DeleteAlert(this.href);">Delete</a></td>
    </tr>
	<% Next %>
            <tr id="htMap">
              <td colspan="8"><!--#include file="pagination.asp"-->
               <% 
			    ps = getPaginationString(page, (numRows + 1), 10, 2, "OSAterms_Definition.asp?type=editOrDelete")
				  Response.Write(ps)
	           %>
