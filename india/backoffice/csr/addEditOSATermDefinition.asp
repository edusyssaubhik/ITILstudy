...
If rqType = "Add" Then
 ...
 strQuery = "INSERT INTO OSAterm_definition (term,definition,addedby,addedon)"
 ...
 Response.Redirect("OSAterms_definition.asp")
...
If rqType = "Update" Then
 ...
 strQuery = "UPDATE OSAterm_definition SET"
...
Else
 ...
 strQuery1 = "DELETE  FROM OSAterm_definition WHERE id = '" & rqDelete & "'"
