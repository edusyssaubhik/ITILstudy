...
<%
 ...
 Dim strQuery1,Rs1,nextPage,lastpage
...
'Sql Query For Retrive The All Users '
 ...
 strQuery = "SELECT * FROM CSIterm_definition Where term like '%"&rqTerm&"%' "
 
 Else
 strQuery = "SELECT * FROM CSIterm_definition"
 End If
...
End If
 ...
 strQuery1  = "SELECT * FROM CSIterm_definition WHERE id = '" & rqEdit & "'"
...
<title>CSI Terms Definition</title>
 ...
 <tr>
  ...
  <tr>
   ...
   <!--#include file="leftMenu.html"-->
    ...
    <table width="100%" >
          <tr>
		   <td width="10%"><a href="CSIterms_Definition.asp?type=add">Add CSI Terms definition</a></td>
		   <% If rqType <> "add" And rqType <> "Edit"  Then %>
 		<form action="CSIterms_Definition.asp" method="post">
   ...
   <tr>
	  <td>
	   <form action="addEditCSITermDefinition.asp" method="post" onSubmit="return validate_form(this)">
	   <table border="0" align="center" cellpadding="5" cellspacing="5" class="dbborder" >
	    <tr>
	      <td colspan="2" align="center" bgcolor="#A7DBFB"><font size="3"><b>Add CSI Terms Definition</b></font></td>
	    </tr>
	    <tr>
	      <td width="30%">Term:</td>
  ...
  <% If rqType = "Edit"  Then %>
      <tr>
         <td>
	       <form action="addEditCSITermDefinition.asp" method="post" onSubmit="return validate_form1(this)">
	       <table border="0" align="center" cellpadding="5" cellspacing="5" class="dbborder">
	        <tr>
	         <td colspan="2" align="center" bgcolor="#A7DBFB"><font size="3"><b>Edit CSI Terms Definition</b></font></td>
	        </tr>
	        <% do until Rs1.EOF %>
    ...
    <tr height="500">
     ...
     <% editTermId = arrAllQueries(0,rowcounter) %>
       ...
       <td align="center"><a href="CSIterms_Definition.asp?type=Edit&editTermId=<% = editTermId %>">Edit</a></td>
       <td align="center"><a href="addEditCSITermDefinition.asp?deleteTermId=<% = editTermId %>" onclick="return DeleteAlert(this.href);">Delete</a></td>
    </tr>
	<% Next %>
            <tr id="htMap">
              <td colspan="8"><!--#include file="pagination.asp"-->
               <% 
			    ps = getPaginationString(page, (numRows + 1), 10, 2, "CSIterms_Definition.asp?type=editOrDelete")
				  Response.Write(ps)
	           %>
