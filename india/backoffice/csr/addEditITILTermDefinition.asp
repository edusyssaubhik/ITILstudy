...
If rqType = "Add" Then
 ...
 strQuery = "INSERT INTO ITILterm_definition (term,definition,addedby,addedon)"
 ...
 Response.Redirect("ITILterms_definition.asp")
...
If rqType = "Update" Then
 ...
 strQuery = "UPDATE ITILterm_definition SET"
...
Else
 ...
 strQuery1 = "DELETE  FROM ITILterm_definition WHERE id = '" & rqDelete & "'"
