...
'======================================================='
  ...
  strQuery = "select * from ITIL_enrolledusers where id =  '" & rqEnrollUserId & "'"
  ...
  Rs.Open strQuery,Conn
   ...
   strQuery1 = "select pricewithouttax,tax,startdate from ITIL_course where courseid =  '" & rqCourseId & "'"
