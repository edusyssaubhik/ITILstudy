      ...
      <td height="235" align="left" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="8">
          ...
          <tr>
            ...
            <td width="73%" rowspan="4" background="/images/back/left_line.jpg" class="general-body"><div style="margin-top:-12px;">
                ...
                <%
					...
					'	Response.write("Test"& coursedate)
						...
						Select Case item_name
                  		      ...
                  		      Case "Understand ITIL Exam" , "Free Simulated Test"
                ...
                "<br />
                <br />
                So, please use another email address to enroll in the understanding ITIL test.<br />
                <br />
				...
				Case else
								...
								ConnObj.Execute "UPDATE PaypalDB SET first_name = '"&StrQuoteReplace(first_name)&"', last_name = '"&StrQuoteReplace(last_name)&"', custom='"&custom&"', ebay_address_id='"&ebay_address_id&"',audio = '"&Audio&"', dietary = '"&Dietary&"', other = '"&Other&"', mobility = '"&Mobility&"', readingORwriting = '"&ReaORWrit&"' WHERE id ='"&payer_id&"'"
