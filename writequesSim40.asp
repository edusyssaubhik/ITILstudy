...
rsQues.Open "SELECT Question_sim40DB.QuestionDesc, Question_sim40DB.CorrectChoice, Question_sim40DB.Justification, Question_sim40DB.ExhibitURL ,Choice_sim40DB.ChoiceNumber, Choice_sim40DB.ChoiceValue from Question_sim40DB, Choice_sim40DB WHERE Question_sim40DB.QuestionNo='"&Quesno&"' and Choice_sim40DB.QuestionNo='"&Quesno&"' and Question_sim40DB.QuestionNo='"&QuesNo&"' and Question_sim40DB.QuestionNo=Choice_sim40DB.QuestionNo ORDER by Choice_sim40DB.ChoiceNumber"
If Not rsQues.BOF Then%>
<P align="center"><B>View/Edit/Add given question:</B><BR><BR></P>
<B><U>View Question:</U></B>&nbsp;&nbsp;&nbsp;<B><a href="./writequesSim40.asp">Home Page</A></B>
<form method="post" action="./writequesSim40.asp">
...
Justification=Replace(Request.Form("Justification"),"'","''")&"<BR><BR>"&Request.Form("comments")
...
<P align="center"><B>View/Edit/Add given question:</B><BR><BR></P>
Information updated in database<B><U>View Question:</U></B>&nbsp;&nbsp;&nbsp;<B><a href="./writequesSim40.asp">Home Page</A></B>
<%
QuesNo=Request.Form("QuesNo")
QuesNoPrev=int(QuesNo)-1%>
<input type="hidden" name="QuesNo" value="<%=QuesNoPrev%>">
...
connObj.Execute "INSERT INTO Question_sim40DB (QuestionNo, QuestionDesc, CorrectChoice, Justification) VALUES ('"&quesno&"','"&questiondesc&"','"&correctchoice&"','"&justification&"')"
connObj.Execute "INSERT INTO Choice_sim40DB(QuestionNo, ChoiceNumber,ChoiceValue) VALUES ('"&quesno&"','"&choice1&"','"&choicevalue1&"')"
connObj.Execute "INSERT INTO Choice_sim40DB(QuestionNo, ChoiceNumber,ChoiceValue) VALUES ('"&quesno&"','"&choice2&"','"&choicevalue2&"')"
connObj.Execute "INSERT INTO Choice_sim40DB(QuestionNo, ChoiceNumber,ChoiceValue) VALUES ('"&quesno&"','"&choice3&"','"&choicevalue3&"')"
connObj.Execute "INSERT INTO Choice_sim40DB(QuestionNo, ChoiceNumber,ChoiceValue) VALUES ('"&quesno&"','"&choice4&"','"&choicevalue4&"')"
addoredit="edit"
else
Response.Write("I am in Edit")
connObj.Execute "update Question_sim40DB Set QuestionDesc='"&questionDesc&"', Justification='"&Justification&"', CorrectChoice='"&CorrectChoice&"' Where QuestionNo='"&quesno&"'"
connObj.Execute "update Choice_sim40DB Set ChoiceValue='"&ChoiceValue1&"' Where  questionno='"&quesno&"' and ChoiceNumber='"&choice1&"'"
connObj.Execute "update Choice_sim40DB Set ChoiceValue='"&ChoiceValue2&"' Where  questionno='"&quesno&"' and ChoiceNumber='"&choice2&"'"
connObj.Execute "update Choice_sim40DB Set ChoiceValue='"&ChoiceValue3&"' Where questionno='"&quesno&"' and ChoiceNumber='"&choice3&"'"
connObj.Execute "update Choice_sim40DB Set ChoiceValue='"&ChoiceValue4&"' Where  questionno='"&quesno&"' and ChoiceNumber='"&choice4&"'"
...
<P align="center"><B>View/Edit/Add given question:</B><BR><BR></P>
<%QuesNo=Request.Form("QuesNo")%>
Question <%=QuesNo%> deleted from database<B><U>View Question:</U></B><form method="post" action="./writequesSim40.asp">
<%
QuesNoPrev=int(QuesNo)-1%>
<input type="hidden" name="QuesNo" value="<%=QuesNoPrev%>">
<input type="hidden" name="submitvalue" value="Initialize">
...
connObj.Execute "delete from Question_sim40DB Where QuestionNo='"&quesno&"'"
connObj.Execute "delete from Choice_sim40DB Where questionno='"&quesno&"'"
...
<BR><BR>
 ...
 <%Else
  ...
  Response.Redirect("/access_Sim40ques.asp")
