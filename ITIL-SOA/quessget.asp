...
rsQues.Open "SELECT Question_SOADB.QuestionDesc, Question_SOADB.CorrectChoice, Question_SOADB.Justification, Question_SOADB.ExhibitURL ,Choice_SOADB.ChoiceNumber, Choice_SOADB.ChoiceValue from Question_SOADB, Choice_SOADB WHERE Question_SOADB.KNo='"&KNo&"' and Choice_SOADB.KNo='"&KNo&"' and Question_SOADB.QuestionNo='"&QuesAsked&"' and Question_SOADB.QuestionNo=Choice_SOADB.QuestionNo ORDER by Choice_SOADB.ChoiceNumber"
