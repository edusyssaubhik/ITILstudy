...
<table width="40%" border="0" cellpadding="0" cellspacing="0">
      ...
      <form method="post" action="/ITIL-OSA/pduquesget1.asp">
    ...
    <FORM METHOD="POST" ACTION="/ITIL-SOA/pduquesget2.asp">
    ...
    <%else
		...
		rsQues.Open "SELECT Question_SOADB.QuestionDesc, Question_SOADB.ExhibitURL ,Choice_SOADB.ChoiceNumber, Choice_SOADB.ChoiceValue from Question_SOADB, Choice_SOADB WHERE Question_SOADB.KNo='"&KNo&"' and Choice_SOADB.KNo='"&KNo&"' and Question_SOADB.QuestionNo='"&sArray(nCurNo,0,0)&"' and Question_SOADB.QuestionNo=Choice_SOADB.QuestionNo Order by Choice_SOADB.ChoiceNumber"
		
		If Not rsQues.BOF Then
	
	%>
    <FORM METHOD="POST" ACTION="/ITIL-SOA/pduquesget1.asp">
		...
		ChoiceValue4=rsQues("ChoiceValue")%>
            ...
            <tr>
              <td height="84" colspan="2" class="TableRowOdd"><div align="left"><span class="PopupCopy">
                  ...
                  <a href="/ITIL-SOA/pdusindex.asp" onclick="return ExitAlert(this.href);"><input type="button" class="ButtonTest" value="Exit" /></a>
                  </span></td>
            </tr>
          </table>
    </form>
...
%>
    There are no questions
     <a href="/ITIL-SOA/pdusindex.asp"><input type="button" class="ButtonTest" value="Exit" /></a>
    <%End If
%>
    <%Session("PDUArray")=sArray
%>
