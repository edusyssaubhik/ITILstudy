          ...
          <tr>
            ...
            <td width="73%" rowspan="4" background="/images/back/left_line.jpg" class="general-body"><div style="margin-top:-12px; width:97%">
                <!-- Content Start From Here-->
				 ...
				 <p>In the final ITIL Intermediate exam, the delegates would need to get 28 out of the available 40 questions (70%) right to pass the Intermediate exam.
                ...
                <div>
                  <p><span class="Header">More than 70% questions answered correctly</p>
                ...
                <div>
                  <p><span class="Header">Less than 70% questions answered correctly</p>
                  <span class="SubHeader">You will need systematic help in preparation for ITIL Intermediate Certification Exam. </span>
