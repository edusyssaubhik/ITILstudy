...
<%
	 ...
	 If Session("payerEmail") <> "" Then
		...
		Else
			...
			Set objRs = connObj.Execute("SELECT SUM(Duration) AS TimeTaken FROM OSAsample2QuesResponse WHERE TestNo = '"& Session("TestNo") & "'")
...
function display_ct() {
   ...
   var hours = Math.floor((window.start - (days * 86400 ))/5400)
   // After days and hours , how many minutes are left
   var minutes = Math.floor((window.start - (days * 86400 ) - (hours * 5400 ))/60)
   // Finally how many seconds left after removing days, hours and minutes.
   var secs = Math.floor((window.start - (days * 86400 ) - (hours * 5400) - (minutes * 60)))
    ...
    <table width="955" border="0" cellspacing="0" cellpadding="3" height="40px">
      <tr>
        ...
        <td colspan="2" bgcolor="#000066"><div align="center" class="">
            <font color="#FFFFFF" face="Arial, Helvetica, sans-serif" size="3"><strong>OSA Sample Paper 2</strong></font></div></td>
