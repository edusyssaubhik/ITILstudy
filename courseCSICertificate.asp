...
<tr>
		<td colspan="3">
			<img src="/images/cert/CSI/CSIP_01.jpg" width="800" height="210" alt=""></td>
	</tr>
	<tr>
		<td rowspan="4">
			<img src="/images/cert/CSI/CSIP_02.jpg" width="20" height="408" alt=""></td>
		<td width="760" height="42" align="center" valign="top" id="user"><% = Session("FirstName") %>&nbsp;<% = Session("LastName") %></td>
		<td rowspan="4">
			<img src="/images/cert/CSI/CSIP_04.jpg" width="20" height="408" alt=""></td>
	</tr>
	<tr>
		<td>
			<img src="/images/cert/CSI/CSIP_05.jpg" width="760" height="132" alt=""></td>
	</tr>
	<tr>
	...
	<tr>
		<td>
			<img src="/images/cert/CSI/CSIP_07.jpg" width="760" height="200" alt=""></td>
	</tr>
