    ...
    <% Else %>
     ...
     <% End If %>
            ...
            <td width="73%" rowspan="4" background="/images/back/left_line.jpg" class="general-body">
                ...
                <div>
                  <h1 class="PageTitle">ITIL<Sup>&reg;</sup> ST CLASSES - DATES, LOCATIONS AND PRICES </h1>
 ...
 <li>Free 18 PMI approved PDUs with our courses <a href="http://itilstudy.com/ITIL-Training/Intermediate_PMIPDU.asp">More</a></li>              
                  ...
                  <li>Free 18 PMI approved PDUs with our courses<a href="http://itilstudy.com/ITIL-Training/Intermediate_PMIPDU.asp">More</a></li>
                   ...
                   <table width="97%" border="0" onMouseOut="javascript:highlightTableRowVersionA(0);" id="myTable0" cellpadding="3" cellspacing="0" class="TableGeneral">
					...
					'Sql Query For Retrive dates'
					 ...
					 strQuery = "SELECT Distinct(startdate), enddate FROM ITIL_course WHERE coursetype = 'ST' and country = '" & Session("CountryOrigin") & "' And startdate BETWEEN '"&Now() - 1&"' AND DATEADD(day,180,'"&Now()&"') order by startdate asc"
				' response.Write(strQuery)				 
					 Rs.Open strQuery,ConnObj
                   ...
                   <tr>
                      <td valign="top" colspan="6"><form name="frmselections">
                          <table width="60%" border="0" cellspacing="0" cellpadding="0" align="center">
                            <tr>					
					  			<td>
								  <select name="country1" id="country1" style="width:150px;" class="TeXtFielddropdown" onChange="findCountry(this.value,'ST');clicked1();">
                             	 ...
                             	 <td>
							  		<Select name="location" id="location" style="width:165px" disabled="disabled" class="TeXtFielddropdown"  onChange="findCity1(this.value,'ST');">
                    ...
                    <tr>
                      <td valign="top" colspan="6"><form name="frmselections">
                          <table width="80%" border="0" cellspacing="0" cellpadding="0" align="center">
                            <tr>
                              <td><select name="location" id="location" style="width:200px;" class="TeXtFielddropdown" onChange="findCity(this.value,'ST');">
			  ...
			  'Created file includes here 
               ...
               <!-- <div><span class="Required">*</span> : Price after early bird discount (if you enroll and pay more than <% 'If Month(Date) = 11 Then %>3<% 'Else %><'% = CourseApplicableDays %><% 'End If %> days before the course start date, and if seats are available)</div>
                ...
                <p><a href="/enrollClass.asp?coursetype=ST" class="Header">ENROLL in ITILstudy
