...
<%
	...
	If generate = "" Then
		...
		strQuery1 ="select TOP 1 * from generate_course WHERE country = '"& Session("CountryOrigin") &"-Dutch' ORDER BY id DESC"
	...
	'==================================================Page==================================================================== 
		...
		strEnding  = "<tr id=""courses"" style=""display:block;""><td colspan=""8""><table border=""0"" cellspacing=""0"" cellpadding=""0""><tr> <td class=""TableRowOdd"" width=""100px""><span class=""HeaderLarge"">Locatie</span></td><td class=""TableRowOdd"" width=""100px""><span class=""HeaderLarge"">Data</span></td><td class=""TableRowOdd"" width=""150px""><span class=""HeaderLarge"">Tijden</span></td><td class=""TableRowOdd"" width=""140px""><span class=""HeaderLarge"">Prijs</span></td><td class=""TableRowOdd"" width=""100px"">&nbsp;</td></tr>"
	...
	strEnding= strEnding &"<br></td><td class="& bgColor &"> "& DAY(arrAllCourses(2,rowCounter)) & " " & MonthName(Month(arrAllCourses(2,rowCounter)),3) & " "  & YEAR(arrAllCourses(2,rowCounter))&" tot <br /> "& DAY(arrAllCourses(3,rowCounter)) & " " & MonthName(Month(arrAllCourses(3,rowCounter)),3) & " "  & YEAR(arrAllCourses(3,rowCounter))&"</td>"
...
Else 
	...
	'PRICE WITH VAT, TAX, GST Before EBD
			...
			strEnding= strEnding &" + BTW  <br />(Totaa1 "&Currency_Format_Front &" "& FormatNumber(arrAllCourses(15,rowCounter)) &" "& Currency_Format_Back &")<sup><font color=""red""><b>*</b></font></sup>"
	...
	'PRICE WITH VAT, TAX, GST After EBD'
			...
			strEnding= strEnding &" + BTW <br />(Totaal "& Currency_Format_Front &" "& FormatNumber(arrAllCourses(12,rowCounter)) &" "& Currency_Format_Back &")"
	...
	strEnding= strEnding &"<td class="& bgColor &"><div align=""center""><form action=""/Dutch/enrollclass.asp"" method=""post""><input type=""hidden"" name=""SelCourseID"" value="& arrAllCourses(0,rowCounter) &" /><input type=""submit"" name=""TypeCourse"" value=""Book"" class=""ButtonSmall""/></form></div></td>"
...
'	End If
	...
	If arrAllCourses(17,rowCounter) = "WBT" Then 
	 If arrAllCourses(0,rowCounter) = "615" Then 
		...
		strEnding= strEnding &"<td class="& bgColor &"><div align=""center""><form action=""/Dutch/enrollclass.asp"" method=""post""><input type=""hidden"" name=""SelCourseID"" value="& arrAllCourses(0,rowCounter) &" /><input type=""submit"" name=""TypeCourse"" value=""Live"" class=""ButtonSmall""/></form></div>"
		Else
		strEnding= strEnding &"<td class="& bgColor &"><div align=""center""><form action=""/Dutch/enrollclass.asp"" method=""post""><input type=""hidden"" name=""SelCourseID"" value="& arrAllCourses(0,rowCounter) &" /><input type=""submit"" name=""TypeCourse"" value=""Live"" class=""ButtonSmall""/></form></div></td>"
		End If	
			   Else 
	If Session("CountryOrigin") = "US" OR Session("CountryOrigin") = "Canada" Then	
	strEnding= strEnding &"<td class="& bgColor &"><table cellspacing=""2""><tr><td><form action=""/Dutch/enrollclass.asp"" method=""post""><input type=""hidden"" name=""SelCourseID"" value="& arrAllCourses(0,rowCounter) &" /><input type=""submit"" name=""TypeCourse"" value=""Live"" class=""ButtonSmall""/></form><form action=""/Dutch/enrollclass.asp"" method=""post""><input type=""hidden"" name=""SelCourseID"" value="& arrAllCourses(0,rowCounter) &" />"	
	Else
	strEnding= strEnding &"<td class="& bgColor &"><table cellspacing=""2""><tr><td><form action=""/Dutch/enrollclass.asp"" method=""post""><input type=""hidden"" name=""SelCourseID"" value="& arrAllCourses(0,rowCounter) &" /><input type=""submit"" name=""TypeCourse"" value=""Live"" class=""ButtonSmall""/></form></td><td><form action=""/Dutch/enrollclass.asp"" method=""post""><input type=""hidden"" name=""SelCourseID"" value="& arrAllCourses(0,rowCounter) &" />"	
	End If
	...
	End If
	Else
	strEnding= strEnding &"<td class="& bgColor &"><div align=""center""><form action=""/Dutch/enrollclass.asp"" method=""post""><input type=""hidden"" name=""SelCourseID"" value="& arrAllCourses(0,rowCounter) &" />"
	...
	Set tsObject = fsoObject.CreateTextFile("E:\vhosts\ITILstudy.com\httpdocs\dateslocation\ITILstudy-Classes-ITILstudy-Training-Dutch-"&Session("CountryOrigin")&".txt")
	
	'Set tsObject = fsoObject.CreateTextFile("C:\GitHub\ITILstudy\dateslocation\ITILstudy-Classes-ITILstudy-Training-Dutch-"&Session("CountryOrigin")&".txt")
	...
	strPay = strPay & "('" & NOW() &"',"
	strPay = strPay & " '" & Session("CountryOrigin")&"-Dutch')"
	IF generate <> "" Then
	conn.Execute strPay
	Else
