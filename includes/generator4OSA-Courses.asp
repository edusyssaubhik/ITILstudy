...
<%
	...
	If generate = "" Then
		...
		strQuery1 ="select TOP 1 * from generate_course WHERE country = '"& Session("CountryOrigin") &"-OSA' ORDER BY id DESC"
...
Else 
	...
	strEnding= strEnding &"<td class="& bgColor &"><div align=""center""><form action=""/enrollclass.asp"" method=""post""><input type=""hidden"" name=""SelCourseID"" value="& arrAllCourses(0,rowCounter) &" /><input type=""hidden"" name=""coursetype"" value=""OSA"" />"
