...
Else 
	...
	strEnding= strEnding &"<td class="& bgColor &"><div align=""center""><form action=""/enrollclass.asp"" method=""post""><input type=""hidden"" name=""SelCourseID"" value="& arrAllCourses(0,rowCounter) &" /><input type=""hidden"" name=""coursetype"" value=""CSI"" />"
	If Session("CountryOrigin") = "United Kingdom" Then 
	...
	strPay = strPay & " '" & Session("CountryOrigin")&"-CSI')"
	IF generate <> "" Then
	conn.Execute strPay
	Else
