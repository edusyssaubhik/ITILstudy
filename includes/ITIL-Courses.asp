...
<!-- Body Starts -->
 ...
 <li>Free <%If Session("CountryOrigin") = "United Kingdom" Then %>27<%Else%>18<%End If%> PMI approved PDUs with our courses <a href="http://itilstudy.com/ITIL-Training/PMI_PDU.asp">More</a></li>
                </ol>
