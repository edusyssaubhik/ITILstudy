...
<td><input type="image" name="sa2" value="Go" id="submitbox" src="/images/buttons/searchbg.gif"/></td>
 ...
 <%End If %>
     ...
     <tr>
      ...
      <tr>
          <td id="imageHover"><a href="/Dutch/ITIL-Courses-nl.asp">
<img height="44px" border="0" alt="courses" src="/images/German/Basic.png">
</a></td>
      </tr> 
	<tr>
    <td id="imageHover">
        <a href="/Dutch/ITIL-Online-Courses-nl.asp">
<img height="44px" border="0" src="/images/buttons/edu.png">
</a>
        </td>
        </tr>
      <tr>
          <td id="imageHover">
              <a href="/Dutch/ITIL-Online-Courses-nl.asp">
<img height="44px" border="0" src="/images/buttons/Blended.png">
</a>
          </td>
      </tr>
    <% else %>
