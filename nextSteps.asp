    ...
    <tr>
      <td height="235" align="left" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="8">
          <tr>
            ...
            <td width="73%" class="PageTitle">Next Steps</td>
          </tr>
          <tr>
            ...
            <td width="73%" rowspan="4" background="/images/back/left_line.jpg" class="general-body"><div style="margin-top:-12px; width:97%">
                ...
                <p>In the final ITIL Foundation exam, the delegates would need to get 26 out of the available 40 questions (65%) right to pass the foundation exam.
				 <BR><BR>Assuming that there may be approximate variation of +- 10 % in the complexity of final ITIL Foundation exam as compared with ITILstudy Simulated test, here are some recommendations: <br></p>
                  
                <div>
                  <p><span class="Header">More than 65% questions answered correctly</p>
                  <span class="SubHeader">You are performing well in the ITILstudy test which is similar to the ITIL Foundation exam format and, you have a very good chance of successfully clearing ITIL exam. </span>
                 
                  <ul>
                    <li> You can enroll in our high impact and result-oriented ITILstudy Classroom Training course (Exam Retake Guarantee if you do not pass the exam after attending our classroom training). 

<br>
                      <br>
                      <a href="/ITIL-Courses.asp">Click here for the list of ITILstudy classroom courses </a></li>
                    <li>If you cannot enroll in ITILstudy classroom programs, and have more time for study, please enroll in ITILstudy.com Online courses this will help you in becoming better prepared for the ITIL Foundation Exam.

<br>
                      <br>
                      <a href="/ITIL-Online-Courses.asp">Click here for the list of ITILstudy online courses</a></li>
                  </ul>
                </div>
                <div>
                  <p><span class="Header">Less than 65% questions answered correctly</p>
                  <span class="SubHeader">You will need systematic help in preparation for ITIL Foundation Certification Exam. </span>
                
                  <ul>
                    <li>It is highly recommended to enroll in our high impact and result-oriented ITILstudy Classroom Training course (Exam Retake Guarantee if you do not pass the exam after attending our classroom training). <br>
                      <br>
                      <a href="/ITIL-Courses.asp">Click here for the list of ITILstudy classroom courses</a></li>
                   </ul>
                </div>
                    ...
                    <td colspan="4">
						<table>
							<tr>
								...
								<td  colspan="2"><textarea cols="50" rows="3" name="personalMessage" onKeyPress="maxlength(this, 1990);"  style="font-family:Arial, Helvetica, sans-serif; font-size:12px;">I have taken a free simulated test on ITILstudy’s website.  I liked it and think you will too</textarea></td>
							</tr>
						</table>
					</td>
                  </tr> 
