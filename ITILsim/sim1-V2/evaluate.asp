...
Set objRs = ConnObj.Execute("SELECT  QuesNo, SelectedChoice, Marked, Duration from FoundV2_Sim1TestResponse WHERE TestNo='"&TestNo&"' ORDER BY GID")

'Retrive The Correct Answer Table'
Set objRs1 = ConnObj.Execute("SELECT  QuesNo, Ans, KNo from FoundV2_Sim1CorrectAns ORDER BY GID")
...
<%
	...
	Set objRs = connObj.Execute("SELECT TestNo FROM FoundV2_Sim1Users WHERE TestNo = '"&TestNo&"' AND KNo1 Is Null")
	
	If (Not objRs.BOF) AND (Not objRs.EOF) Then
	
	 	OverAllPercentage =correctans/6*100
 	
		Set objRs = connObj.Execute("Update  FoundV2_Sim1Users SET EMail = '"&Session("PayerEmail")&"', KNo1 = "&int(kno1/kno1ques*100)&",KNo2 = "&int(kno2/kno2ques*100)&",KNo3 = "&int(kno3/kno3ques*100)&",KNo4 = "&int(kno4/kno4ques*100)&",KNo5 = "&int(kno5/kno5ques*100)&",KNo6 = "&int(kno6/kno6ques*100)&",OverAll = "&OverAllPercentage&" WHERE TestNo = '"&TestNo&"'")
