...
Set objRss = Server.CreateObject("ADODB.Recordset")
	...
	Session("MaxQuesNo") = ""
				...
				Select Case State
					...
					Case "verified1" ,"verified2"  ,"verified3" , "verified5" ,"verified6" ,"verified7" 
...
%>
          ...
          <br>
          <a href="/ITILsim/practicetest1.asp">Understanding ITIL  Foundation sample paper</A> - Please read the instructions below before taking up the test.<br>
          <br>
         All questions answered by you are stored in ITILstudy database. So, to <span class="general-bodyBold">continue a test which you have not completed</span>,
          <ul>
            ...
            <li>Please note : All your answers for the APMG sample paper are saved for "MAXIMUM OF 1 WEEK".
              </span></li>
          </ul>
          <% 
			...
			'Retrive Test Numbers Based on EMail Ids'
				...
				strQuery = "SELECT TestNo FROM SimITILusertable WHERE EMail = '"& Session("PayerEmail")&"' AND Kno1 Is Null Order By TestNo Desc"
				...
				strQuery = "SELECT TestNo FROM SimITILusertable WHERE EMail = '"& Session("PayerEmail")&"' AND Kno1 Is Not Null Order By TestNo Desc"
          ...
          <table border="0" cellpadding="3" width="100%" style="border:1px #CCCCCC solid;" cellspacing="0" onMouseOut="javascript:highlightTableRowVersionA(0);" id="myTable0" >
            <tr onMouseOver="javascript:highlightTableRowVersionA(this, '#FFFFCC');">
              <td colspan="2" class="TableRowOdd"><span class="Header">APMG sample paper
                </span></td>
            </tr>
            <tr onMouseOver="javascript:highlightTableRowVersionA(this, '#FFFFCC');">
              <td colspan="2" class="TableRowEven"><form method="post" action="/ITILsim/sim1/TestRules.asp">
            ...
            <tr onMouseOver="javascript:highlightTableRowVersionA(this, '#FFFFCC');">
              <td class="TableRowEven" style="border-right:1px #CCCCCC solid;"><form method="post" action="/ITILsim/sim1/TestRules.asp" onsubmit="returnvalidate_form(this)">
                  Test Number:
              ...
              <td class="TableRowEven"><form method="post" action="/ITILsim/sim1/evaluate.asp" onsubmit="return validate_form(this)">
                  Test Number:
                  <select name="TestNo" class="TeXtFielddropdown" style="width:70px;">
                    <option value="">Select</option>
                    <% Do Until objRss.Eof %>
