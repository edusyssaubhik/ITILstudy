...
Set objRs = ConnObj.Execute("SELECT  QuesNo, SelectedChoice, Marked, Duration from SimITILTestResponse WHERE TestNo='"&Session("TestNo")&"' ORDER BY GID")
'Response.write("SELECT  QuesNo, SelectedChoice, Marked, Duration from SimITILTestResponse WHERE TestNo='"&TestNo&"' ORDER BY GID")
'Retrive The Correct Answer Table'
Set objRs1 = ConnObj.Execute("SELECT  QuesNo, Ans, KNo from SimITILCorrectAns ORDER BY GID")
...
<a name="go"></a>
<%
markstotal = FormatNumber(correctans/0.40,2)
...
<font size="3px"><b><i><a href="http://www.itilstudy.com/ITIL-Online-Courses.asp">Enroll</a> with us to increase your score from <%=FormatNumber(correctans/0.40,2)%>% to more than 65!</i></b></font></b><br/><br/>
<b>Our confidence in our qaulity is reflected by the fact that we are the only ITIL Foundation Training provider in the industry to offer Exam Retake Guarantee.<br/><br/>
Book Online or call <font color="#0099FF">0800 0337 947</font> to speak to an ITIl Training Counsellor today.<br/><br/>
To know Percentage Score In Different Knowledge Area Please <a href="/ITILsim/sim1/evaluate.asp?type=display#more">Click Here</a></b><br/><br/>
<%End If%>


<%If rqtype = "display" or markstotal >= 65 Then%>
...
<%
	  ...
	  Set objRs = connObj.Execute("SELECT TestNo FROM SimITILusertable WHERE TestNo = '"&Session("TestNo")&"' AND KNo1 Is Null")	
		...
		Set objRs = connObj.Execute("Update  SimITILusertable SET EMail = '"&Session("PayerEmail")&"', KNo1 = "&int(kno1/kno1ques*100)&",KNo2 = "&int(kno2/kno2ques*100)&",KNo3 = "&int(kno3/kno3ques*100)&",KNo4 = "&int(kno4/kno4ques*100)&",KNo5 = "&int(kno5/kno5ques*100)&",KNo6 = "&int(kno6/kno6ques*100)&",OverAll = "&OverAllPercentage&" WHERE TestNo = '"&Session("TestNo")&"'")
...
'Sending exam result email to the user
	...
	If markstotal < 65 Then 
	strBody = strBody & "<tr><td><span style=""font-family: Arial, Helvetica, sans-serif;font-size: 13px;font-weight: bold;line-height: 18px;font-style: normal;padding-top: 5px;padding-bottom: 5px;"" ><p><font size=""2px""><b>98% of students passed ITIL Certification exam with <a href=""http://www.ITIlstudy.com"">ITILstudy</a>! </b></font><br/><br/><font size=""3px""><b><i><a href=""http://www.itilstudy.com/ITIL-Online-Courses.asp"">Enroll</a> with us to increase your score from "&markstotal&"% to more than 65!</i></b></font></b><br/><br/><b>Our confidence in our qaulity is reflected by the fact that we are the only ITIL Foundation Training provider in the industry to offer Exam Retake Guarantee.<br/><br/>Book Online or call <font color=""#0099FF"">0800 0337 947</font> to speak to an ITIl Training Counsellor today.<br/></span></td></tr>"
	...
	strBody = strBody & "<tr><td><font face=""Arial"" size=""2"">"

	 Percentage = FormatNumber(correctans/0.40,2)
	
	If Percentage >= 65 Then
	
	strBody = strBody & " We would like to congratulate you on doing well in the Mock Exam and hope that you would do better in the actual exam with ITILstudy."
	Else 
	strBody = strBody & " We hope that the mock exam gave you a better understanding of the actual ITIL exam and recommend you to get back to the study guides of the chapters where you struggled in this exam."
	 End If 
	strBody = strBody & "</span></td></tr>"
	...
	strBody1 = "<table width=""100%"" border=""0"" bgcolor=""#CCCCCC"" style=""margin:0px;0px;0px;0px;"">"
	...
	strBody1 = strBody1 & "<table border=""0"" cellpadding=""6"" width=""100%"">"
	...
	strBody1 = strBody1 & "<tr><td><font face=""Arial"" size=""2""><form method=""post"" action=""http://www.ITILstudy.com/ITIL/insertFeedback.asp""><input type=""hidden"" name=""Name"" value="&Session("FirstName")&"&nbsp;"&Session("LastName")&"><input type=""hidden"" name=""email"" value="&payer_email&">"
	

	strBody1 = strBody1 & "<br><br>Participant Name: &nbsp;&nbsp;&nbsp;&nbsp;<input type = ""text"" value="&Session("FirstName")&"&nbsp;"&Session("LastName")&" /><br><br>Instructor:&nbsp;&nbsp;&nbsp;&nbsp;ITILstudy Online CBT Training Course<br><br>Course Dates<br><br>Start Date :&nbsp;&nbsp;&nbsp;&nbsp;"&Session("DateEntered")&"<br><Br>End Date :&nbsp;&nbsp;&nbsp;&nbsp;"&date()&"<br><br>Location<br><br>city :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=""text"" name=""city"" id=""city"" size=""20"" /><br><br>Country :&nbsp;&nbsp;&nbsp;&nbsp;<input type=""text"" name=""country"" id=""country"" size=""20"" /><br><br>Rate the following (Scale 1 to 10; 10 = Best, 1 = Worst)<br><br>Study Guides :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select name=""studyguides""><option value=""1"">1</option><option value=""2"">2</option><option value=""3"">3</option><option value=""4"">4</option><option value=""5"">5</option><option value=""6"">6</option><option value=""7"">7</option<option value=""8"">8</option><option value=""9"">9</option><option value=""10"">10</option></select><br><br>Study Methodology:&nbsp;&nbsp;&nbsp;<select name=""studyMethodology""><option value=""1"">1</option><option value=""2"">2</option><option value=""3"">3</option><option value=""4"">4</option><option value=""5"">5</option><option value=""6"">6</option><option value=""7"">7</option><option value=""8"">8</option><option value=""9"">9</option> <option value=""10"">10</option></select><br><br>Web Interface:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select name=""webInterface""><option value=""1"">1</option><option value=""2"">2</option><option value=""3"">3</option><option value=""4"">4</option><option value=""5"">5</option> <option value=""6"">6</option><option value=""7"">7</option><option value=""8"">8</option><option value=""9"">9</option><option value=""10"">10</option></select><br><Br>Chapter Tests: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select name=""chapterTests""><option value=""1"">1</option><option value=""2"">2</option><option value=""3"">3</option><option value=""4"">4</option><option value=""5"">5</option><option value=""6"">6</option><option value=""7"">7</option><option value=""8"">8</option><option value=""9"">9</option><option value=""10"">10</option></select><br><br>Mock Test: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<select name=""MockTest""><option value=""1"">1</option><option value=""2"">2</option><option value=""3"">3</option><option value=""4"">4</option><option value=""5"">5</option><option value=""6"">6</option><option value=""7"">7</option><option value=""8"">8</option><option value=""9"">9</option><option value=""10"">10</option></select><br><br>What did you like about the Course:&nbsp;&nbsp;<textarea name=""course"" rows=""5"" cols=""20""></textarea><br><br>Improvement Opportunity:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<textarea name=""Improvement"" rows=""5"" cols=""20""></textarea><br><br>Any other comments : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<textarea name=""comments"" rows=""5"" cols=""20""></textarea><br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=""Submit"" name=""type"" value=""Submit"" /></td></tr>"
