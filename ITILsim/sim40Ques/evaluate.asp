...
Set objRs = ConnObj.Execute("SELECT  QuesNo, SelectedChoice, Marked, Duration from Sim40QuesResponse WHERE TestNo='"&Session("TestNo")&"' ORDER BY GID")
...
<font size="3px"><b><i><a href="http://www.itilstudy.com//ITIL-Courses.asp">Enroll</a> with us to increase your score from <%=markstotal%>% to more than 65!</i></b></font></b><br/><br/>
...
<% If Session("CountryOrigin") = "India" Then %>
		 ...
		 <font color="#0099FF">080 41557547</font> 
	
	<% ElseIf Session("CountryOrigin") = "US" OR Session("CountryOrigin") ="Canada" Then %>
	
		 <font color="#0099FF">+1-855-234-845</font> 
	
	<% ElseIf Session("CountryOrigin") = "Australia" Then %>
	
		<font color="#0099FF">+61 2 88964376</font> 

	<% ElseIf Session("CountryOrigin") = "UAE" Then %>
		
		 <font color="#0099FF">50-2757445</font> 
	
	<% ElseIf Session("CountryOrigin") = "United Kingdom" Then %>
	
     <font color="#0099FF">0800 0337 097</font> 
	
	<% End If %> to speak to an ITIL Training Counsellor today.<br/><br/>
    
To know Percentage Score In Different Knowledge Area Please <a href="/ITILsim/Sim40Ques/evaluate.asp?type=display#more">Click Here</a></b><br/><br/>
<%End If%>
...
<%
		...
		Set objRs = connObj.Execute("SELECT TestNo FROM Sim40QuesUserTable WHERE TestNo = '"&Session("TestNo")&"' AND KNo1 Is Null")
		...
		Set objRs = connObj.Execute("Update  Sim40QuesUserTable SET EMail = '"&Session("PayerEmail")&"', KNo1 = "&int(kno1/kno1ques*100)&",KNo2 = "&int(kno2/kno2ques*100)&",KNo3 = "&int(kno3/kno3ques*100)&",KNo4 = "&int(kno4/kno4ques*100)&",KNo5 = "&int(kno5/kno5ques*100)&",KNo6 = "&int(kno6/kno6ques*100)&",OverAll = "&OverAllPercentage&" WHERE TestNo = '"&Session("TestNo")&"'")
