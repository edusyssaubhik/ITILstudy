...
<td><input type="image" name="sa2" value="Go" id="submitbox" src="/images/buttons/searchbg.gif"/></td>
  ...
  <% 'FOR ITIL Intermediate (PPO) Online course'
    ...
    <tr>
      <td>
        <form name="search" action="/ITILPPOsearch.asp" method="post" style="display:inline" target="_blank" onsubmit="return Form_Validator(this)">
         <table border="0px" cellpadding="0px" cellspacing="0px" width="100%"><tr>
        <td width="142px;"> 
...
<% 'FOR ITIL Intermediate (SOA) Online course'
    ...
    <tr>
      <td>
        <form name="search" action="/ITILSOAsearch.asp" method="post" style="display:inline" target="_blank" onsubmit="return Form_Validator(this)">
         <table border="0px" cellpadding="0px" cellspacing="0px" width="100%"><tr>
        <td width="142px;"> 
    ...
    <tr>
      <td class="subMenu"><a href="/ITIL-SOA/chapterTestsIndex.asp"  id='menulk'>- Chapter Test &nbsp; &nbsp;</a></td>
	    ...
	    <tr>
      <td class="subMenu"><a href="/ITIL-SOA/scenarioChapterTest.asp"  id='menulk'>- Scenario Based Chapter Test &nbsp; &nbsp;</a></td>
    </tr>
    ...
    <tr>
	 ...
	 <tr>
      <td><a href="/ITIL-SOA-Sample1/sample1Ques/TestRules.asp"  id='menulk'>SOA Sample Paper 1 &nbsp; &nbsp;</a></td>
    </tr>
    <tr>
      <td class="bottomBorder">&nbsp;</td>
    </tr>
	 <tr>
      <td><a href="/ITIL-SOA-Sample2/sample2Ques/TestRules.asp"  id='menulk'>SOA Sample Paper 2 &nbsp; &nbsp;</a></td>
    </tr>
    <tr>
      <td class="bottomBorder">&nbsp;</td>
    </tr>
     ...
     <% If Session("KnoPassed") = 8 Then %>
		   <tr>
		   <td>
		 <a href="/courseSOACertificate.asp" target="_blank"  id='menulk' >Course Certificate &nbsp; &nbsp;</a>  
</td></tr>
 <tr>
      <td class="bottomBorder">&nbsp;</td>
    </tr>
...
<% 'FOR ITIL Intermediate (RCV) Online course'
    ...
    <tr>
      <td class="subMenu"><a href="/ITIL-RCV/chapterTestsIndex.asp"  id='menulk'>- Chapter Test &nbsp; &nbsp;</a></td>
	    ...
	    <tr>
      <td class="subMenu"><a href="/ITIL-RCV/scenarioChapterTest.asp"  id='menulk'>- Scenario Based Chapter Test &nbsp; &nbsp;</a></td>
    </tr>
    ...
    <tr>
	 ...
	 <tr>
      <td><a href="/ITIL-RCV-Sample1/sample1Ques/TestRules.asp"  id='menulk'>RCV Sample Paper 1 &nbsp; &nbsp;</a></td>
    </tr>
    <tr>
      <td class="bottomBorder">&nbsp;</td>
    </tr>
	 <tr>
      <td><a href="/ITIL-RCV-Sample2/sample2Ques/TestRules.asp"  id='menulk'>RCV Sample Paper 2 &nbsp; &nbsp;</a></td>
    </tr>
    <tr>
      <td class="bottomBorder">&nbsp;</td>
    </tr>
