...
rsQues.Open "SELECT Question_ITILFondDB_Dec2011.QuestionDesc, Question_ITILFondDB_Dec2011.CorrectChoice, Question_ITILFondDB_Dec2011.Justification, Question_ITILFondDB_Dec2011.ExhibitURL ,Choice_ITILFondDB_Dec2011.ChoiceNumber, Choice_ITILFondDB_Dec2011.ChoiceValue from Question_ITILFondDB_Dec2011, Choice_ITILFondDB_Dec2011 WHERE Question_ITILFondDB_Dec2011.KNo='"&KNo&"' and Choice_ITILFondDB_Dec2011.KNo='"&KNo&"' and Question_ITILFondDB_Dec2011.QuestionNo='"&QuesNo&"' and Question_ITILFondDB_Dec2011.QuestionNo=Choice_ITILFondDB_Dec2011.QuestionNo ORDER by Choice_ITILFondDB_Dec2011.ChoiceNumber"
If Not rsQues.BOF Then%>
<P align="center"><B>View/Edit/Add given question:</B><BR><BR></P>
<B><U>View Question:</U></B>&nbsp;&nbsp;&nbsp;<B><a href="./writequesITILNew.asp">Home Page</A></B>
<form method="post" action="./writequesITILNew.asp">
...
<P align="center"><B>View/Edit/Add given question:</B><BR><BR></P>
Information updated in database<B><U>View Question:</U></B>&nbsp;&nbsp;&nbsp;<B><a href="./writequesITILNew.asp">Home Page</A></B>
<%
QuesNo=Request.Form("QuesNo")
KNo=Request.Form("KNo")
QuesNoPrev=int(QuesNo)-1%>
...
connObj.Execute "INSERT INTO Question_ITILFondDB_Dec2011 (QuestionNo, KNo, QuestionDesc, CorrectChoice, Justification) VALUES ('"&quesno&"','"&kno&"','"&questiondesc&"','"&correctchoice&"','"&justification&"')"
connObj.Execute "INSERT INTO Choice_ITILFondDB_Dec2011(QuestionNo, ChoiceNumber,ChoiceValue,KNo) VALUES ('"&quesno&"','"&choice1&"','"&choicevalue1&"','"&kno&"')"
connObj.Execute "INSERT INTO Choice_ITILFondDB_Dec2011(QuestionNo, ChoiceNumber,ChoiceValue,KNo) VALUES ('"&quesno&"','"&choice2&"','"&choicevalue2&"','"&kno&"')"
connObj.Execute "INSERT INTO Choice_ITILFondDB_Dec2011(QuestionNo, ChoiceNumber,ChoiceValue,KNo) VALUES ('"&quesno&"','"&choice3&"','"&choicevalue3&"','"&kno&"')"
connObj.Execute "INSERT INTO Choice_ITILFondDB_Dec2011(QuestionNo, ChoiceNumber,ChoiceValue,KNo) VALUES ('"&quesno&"','"&choice4&"','"&choicevalue4&"','"&kno&"')"
addoredit="edit"
else
Response.Write("I am in Edit")
connObj.Execute "update Question_ITILFondDB_Dec2011 Set QuestionDesc='"&questionDesc&"', Justification='"&Justification&"', CorrectChoice='"&CorrectChoice&"' Where kno='"&kno&"' and QuestionNo='"&quesno&"'"
connObj.Execute "update Choice_ITILFondDB_Dec2011 Set ChoiceValue='"&ChoiceValue1&"' Where kno='"&kno&"' and questionno='"&quesno&"' and ChoiceNumber='"&choice1&"'"
connObj.Execute "update Choice_ITILFondDB_Dec2011 Set ChoiceValue='"&ChoiceValue2&"' Where kno='"&kno&"' and questionno='"&quesno&"' and ChoiceNumber='"&choice2&"'"
connObj.Execute "update Choice_ITILFondDB_Dec2011 Set ChoiceValue='"&ChoiceValue3&"' Where kno='"&kno&"' and questionno='"&quesno&"' and ChoiceNumber='"&choice3&"'"
connObj.Execute "update Choice_ITILFondDB_Dec2011 Set ChoiceValue='"&ChoiceValue4&"' Where kno='"&kno&"' and questionno='"&quesno&"' and ChoiceNumber='"&choice4&"'"
...
connObj.Execute "delete from Question_ITILFondDB_Dec2011 Where kno='"&kno&"' and QuestionNo='"&quesno&"'"
connObj.Execute "delete from Choice_ITILFondDB_Dec2011 Where kno='"&kno&"' and questionno='"&quesno&"'"
