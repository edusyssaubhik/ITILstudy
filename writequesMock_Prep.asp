...
rsQues.Open "SELECT Question_MockPrepDB.QuestionDesc, Question_MockPrepDB.CorrectChoice, Question_MockPrepDB.Justification, Question_MockPrepDB.ExhibitURL ,Choice_MockPrepDB.ChoiceNumber, Choice_MockPrepDB.ChoiceValue from Question_MockPrepDB, Choice_MockPrepDB WHERE Question_MockPrepDB.KNo='"&KNo&"' and Choice_MockPrepDB.KNo='"&KNo&"' and Question_MockPrepDB.QuestionNo='"&QuesNo&"' and Question_MockPrepDB.QuestionNo=Choice_MockPrepDB.QuestionNo ORDER by Choice_MockPrepDB.ChoiceNumber"
If Not rsQues.BOF Then%>
<P align="center"><B>View/Edit/Add given question:</B><BR><BR></P>
<B><U>View Question:</U></B>&nbsp;&nbsp;&nbsp;<B><a href="./writequesMock_Prep.asp">Home Page</A></B>
<form method="post" action="./writequesMock_Prep.asp">
...
<P align="center"><B>View/Edit/Add given question:</B><BR><BR></P>
Information updated in database<B><U>View Question:</U></B>&nbsp;&nbsp;&nbsp;<B><a href="./writequesMock_Prep.asp">Home Page</A></B>
<%
QuesNo=Request.Form("QuesNo")
KNo=Request.Form("KNo")
QuesNoPrev=int(QuesNo)-1%>
...
connObj.Execute "INSERT INTO Question_MockPrepDB (QuestionNo, KNo, QuestionDesc, CorrectChoice, Justification) VALUES ('"&quesno&"','"&kno&"','"&questiondesc&"','"&correctchoice&"','"&justification&"')"
connObj.Execute "INSERT INTO Choice_MockPrepDB(QuestionNo, ChoiceNumber,ChoiceValue,KNo) VALUES ('"&quesno&"','"&choice1&"','"&choicevalue1&"','"&kno&"')"
connObj.Execute "INSERT INTO Choice_MockPrepDB(QuestionNo, ChoiceNumber,ChoiceValue,KNo) VALUES ('"&quesno&"','"&choice2&"','"&choicevalue2&"','"&kno&"')"
connObj.Execute "INSERT INTO Choice_MockPrepDB(QuestionNo, ChoiceNumber,ChoiceValue,KNo) VALUES ('"&quesno&"','"&choice3&"','"&choicevalue3&"','"&kno&"')"
connObj.Execute "INSERT INTO Choice_MockPrepDB(QuestionNo, ChoiceNumber,ChoiceValue,KNo) VALUES ('"&quesno&"','"&choice4&"','"&choicevalue4&"','"&kno&"')"
addoredit="edit"
else
Response.Write("I am in Edit")
connObj.Execute "update Question_MockPrepDB Set QuestionDesc='"&questionDesc&"', Justification='"&Justification&"', CorrectChoice='"&CorrectChoice&"' Where kno='"&kno&"' and QuestionNo='"&quesno&"'"
connObj.Execute "update Choice_MockPrepDB Set ChoiceValue='"&ChoiceValue1&"' Where kno='"&kno&"' and questionno='"&quesno&"' and ChoiceNumber='"&choice1&"'"
connObj.Execute "update Choice_MockPrepDB Set ChoiceValue='"&ChoiceValue2&"' Where kno='"&kno&"' and questionno='"&quesno&"' and ChoiceNumber='"&choice2&"'"
connObj.Execute "update Choice_MockPrepDB Set ChoiceValue='"&ChoiceValue3&"' Where kno='"&kno&"' and questionno='"&quesno&"' and ChoiceNumber='"&choice3&"'"
connObj.Execute "update Choice_MockPrepDB Set ChoiceValue='"&ChoiceValue4&"' Where kno='"&kno&"' and questionno='"&quesno&"' and ChoiceNumber='"&choice4&"'"
...
<P align="center"><B>View/Edit/Add given question:</B><BR><BR></P>
<%QuesNo=Request.Form("QuesNo")%>
Question <%=QuesNo%> deleted from database<B><U>View Question:</U></B><form method="post" action="./writequesMock_Prep.asp">
<%
KNo=Request.Form("KNo")
QuesNoPrev=int(QuesNo)-1%>
<input type="hidden" name="QuesNo" value="<%=QuesNoPrev%>">
...
connObj.Execute "delete from Question_MockPrepDB Where kno='"&kno&"' and QuestionNo='"&quesno&"'"
connObj.Execute "delete from Choice_MockPrepDB Where kno='"&kno&"' and questionno='"&quesno&"'"
...
<BR><BR>
 ...
 <%Else
  ...
  Response.Redirect("/access_MockPrep.asp")
