...
'Retrive the states from Pmstudy table ps_us_states'
strUKState = "SELECT states, statecode FROM ps_us_states WHERE country = 'United Kingdom' ORDER BY states"

objRs.Open strUKState,ConnObj1
...
<table border="1" cellpadding="5" cellspacing="0" align="center" width="45%">
 ...
 <tr>
  <td>
  <form name="addcalls" action="addukcalls.asp" method="post" onsubmit="return Form_Validator(this)">
